...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForEffectChannels, 0x6c);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForEffectGroups, 0xc0);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForMusicChannels, 0x114);
