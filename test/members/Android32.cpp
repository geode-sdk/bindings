...
GEODE_SIZE_CHECK(tk::spline, 0x70);
GEODE_MEMBER_CHECK(tk::spline, m_x, 0x0);
GEODE_MEMBER_CHECK(tk::spline, m_y, 0xc);
GEODE_MEMBER_CHECK(tk::spline, m_b, 0x18);
GEODE_MEMBER_CHECK(tk::spline, m_c, 0x24);
GEODE_MEMBER_CHECK(tk::spline, m_d, 0x30);
GEODE_MEMBER_CHECK(tk::spline, m_c0, 0x40);
GEODE_MEMBER_CHECK(tk::spline, m_type, 0x48);
GEODE_MEMBER_CHECK(tk::spline, m_left, 0x4c);
GEODE_MEMBER_CHECK(tk::spline, m_right, 0x50);
GEODE_MEMBER_CHECK(tk::spline, m_leftValue, 0x58);
GEODE_MEMBER_CHECK(tk::spline, m_rightValue, 0x60);
GEODE_MEMBER_CHECK(tk::spline, m_madeMonotonic, 0x68);
