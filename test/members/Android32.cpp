...
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat1, 0x18);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat2, 0x1c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat3, 0x20);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat4, 0x24);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat5, 0x28);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat6, 0x2c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat7, 0x30);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat8, 0x34);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat9, 0x38);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat10, 0x3c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat11, 0x40);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat12, 0x44);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat13, 0x48);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat14, 0x4c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat15, 0x50);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat16, 0x54);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat17, 0x58);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat18, 0x5c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat19, 0x60);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat20, 0x64);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat21, 0x68);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat22, 0x6c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat23, 0x70);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat24, 0x74);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat25, 0x78);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat26, 0x7c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat27, 0x80);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat28, 0x84);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat29, 0x88);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat30, 0x8c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat31, 0x90);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool1, 0x94);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool2, 0x95);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat32, 0x98);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat33, 0x9c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat34, 0xa0);
...
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat40, 0xd0);
...
GEODE_MEMBER_CHECK(GJGameState, m_unkUint18, 0x6cc);
GEODE_MEMBER_CHECK(GJGameState, m_ground, 0x6d0);
GEODE_MEMBER_CHECK(GJGameState, m_unkUint19, 0x6d4);
GEODE_MEMBER_CHECK(GJGameState, m_unkBool31, 0x6d8);
GEODE_MEMBER_CHECK(GJGameState, m_unkUint20, 0x6dc);
...
GEODE_MEMBER_CHECK(GJShaderState, m_blurRefChannel, 0x274);
GEODE_MEMBER_CHECK(GJShaderState, m_somethingZLayerUnk278, 0x278);
...
GEODE_MEMBER_CHECK(FMODSoundState, m_unkInt1, 0x90);
GEODE_MEMBER_CHECK(FMODSoundState, m_unkBool1, 0x94);
GEODE_MEMBER_CHECK(FMODSoundState, m_keyForFMODMusicMap, 0x98);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapPairIntIntFMODSoundTween2, 0x20);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapPairIntIntFMODSoundTween3, 0x38);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels1, 0x50);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels2, 0x6c);
GEODE_MEMBER_CHECK(FMODAudioState, m_pitchForChannels1, 0x88);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels3, 0xa4);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels4, 0xc0);
GEODE_MEMBER_CHECK(FMODAudioState, m_pitchForChannels2, 0xdc);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFloat1, 0xf8);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFloat2, 0x114);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFloat3, 0x130);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFloat4, 0x14c);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFMODQueuedMusic1, 0x168);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFMODQueuedMusic2, 0x184);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFMODSoundState, 0x1a0);
...
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_rotateGameplayOnly, 0x11d);
...
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_hasGhostTrail, 0x128);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isMini, 0x12c);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_speed, 0x130);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isHidden, 0x134);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isGoingLeft, 0x135);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_maybeReverseSpeed, 0x138);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isDashing, 0x13c);
...
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_dashRing, 0x150);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isAutoCheckpoint, 0x154);
...
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt1, 0xa14);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt2, 0xa18);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt3, 0xa1c);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkBool1, 0xa20);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkBool2, 0xa21);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt4, 0xa24);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt5, 0xa28);
GEODE_MEMBER_CHECK(CheckpointObject, m_vectorDynamicSaveObjects, 0xa2c);
