...
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat1, 0x30);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat2, 0x34);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat3, 0x38);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat4, 0x3c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat5, 0x40);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat6, 0x44);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat7, 0x48);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat8, 0x4c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat9, 0x50);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat10, 0x54);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat11, 0x58);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat12, 0x5c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat13, 0x60);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat14, 0x64);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat15, 0x68);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat16, 0x6c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat17, 0x70);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat18, 0x74);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat19, 0x78);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat20, 0x7c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat21, 0x80);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat22, 0x84);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat23, 0x88);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat24, 0x8c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat25, 0x90);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat26, 0x94);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat27, 0x98);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat28, 0x9c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat29, 0xa0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat30, 0xa4);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat31, 0xa8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool1, 0xac);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool2, 0xad);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat32, 0xb0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat33, 0xb4);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat34, 0xb8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_gameObject, 0xc0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool3, 0xc8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat35, 0xcc);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat36, 0xd0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat37, 0xd4);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat38, 0xd8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool4, 0xdc);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool5, 0xdd);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool6, 0xde);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat39, 0xe0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkVecInt, 0xe8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat40, 0x100);
...
GEODE_MEMBER_CHECK(GJShaderState, m_radialBlurUnk18c, 0x1b4);
...
GEODE_MEMBER_CHECK(GJShaderState, m_blurRefChannel, 0x2ac);
GEODE_MEMBER_CHECK(GJShaderState, m_somethingZLayerUnk278, 0x2b0);
...
GEODE_MEMBER_CHECK(FMODSoundState, m_unkInt1, 0x98);
GEODE_MEMBER_CHECK(FMODSoundState, m_unkBool1, 0x9c);
GEODE_MEMBER_CHECK(FMODSoundState, m_keyForFMODMusicMap, 0xa0);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapPairIntIntFMODSoundTween2, 0x38);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapPairIntIntFMODSoundTween3, 0x68);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels1, 0x98);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels2, 0xd0);
GEODE_MEMBER_CHECK(FMODAudioState, m_pitchForChannels1, 0x108);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels3, 0x140);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForChannels4, 0x178);
GEODE_MEMBER_CHECK(FMODAudioState, m_pitchForChannels2, 0x1b0);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkMapIntFloat1, 0x1e8);
...
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_rotateGameplayOnly, 0x151);
...
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_hasGhostTrail, 0x15c);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isMini, 0x160);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_speed, 0x164);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isHidden, 0x168);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isGoingLeft, 0x169);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_maybeReverseSpeed, 0x16c);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isDashing, 0x170);
...
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt1, 0xe78);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt2, 0xe7c);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt3, 0xe80);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkBool1, 0xe84);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkBool2, 0xe85);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt4, 0xe88);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt5, 0xe8c);
GEODE_MEMBER_CHECK(CheckpointObject, m_vectorDynamicSaveObjects, 0xe90);
...
GEODE_MEMBER_CHECK(CheckpointObject, m_unkBool3, 0x11e8);
GEODE_MEMBER_CHECK(CheckpointObject, m_sequenceTriggerStateUnorderedMap, 0x11f0);
GEODE_MEMBER_CHECK(CheckpointObject, m_unkInt6, 0x1228);
