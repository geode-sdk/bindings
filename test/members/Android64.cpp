...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForEffectChannels, 0xd0);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForEffectGroups, 0x178);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForMusicChannels, 0x220);
