...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForEffectChannels, 0x78);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForEffectGroups, 0x138);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeFactorForMusicChannels, 0x1f8);
