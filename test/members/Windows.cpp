...
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat1, 0x10);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat2, 0x14);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat3, 0x18);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat4, 0x1c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat5, 0x20);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat6, 0x24);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat7, 0x28);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat8, 0x2c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat9, 0x30);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat10, 0x34);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat11, 0x38);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat12, 0x3c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat13, 0x40);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat14, 0x44);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat15, 0x48);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat16, 0x4c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat17, 0x50);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat18, 0x54);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat19, 0x58);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat20, 0x5c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat21, 0x60);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat22, 0x64);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat23, 0x68);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat24, 0x6c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat25, 0x70);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat26, 0x74);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat27, 0x78);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat28, 0x7c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat29, 0x80);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat30, 0x84);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat31, 0x88);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool1, 0x8c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool2, 0x8d);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat32, 0x90);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat33, 0x94);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat34, 0x98);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_gameObject, 0xa0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool3, 0xa8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat35, 0xac);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat36, 0xb0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat37, 0xb4);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat38, 0xb8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool4, 0xbc);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool5, 0xbd);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkBool6, 0xbe);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat39, 0xc0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkVecInt, 0xc8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unkFloat40, 0xe0);
...
GEODE_MEMBER_CHECK(PulseEffectAction, m_stopped, 0x0);
...
GEODE_MEMBER_CHECK(PulseEffectAction, m_runningTime, 0x10);
GEODE_MEMBER_CHECK(PulseEffectAction, m_groupID, 0x14);
GEODE_MEMBER_CHECK(PulseEffectAction, m_interpValue, 0x18);
...
GEODE_MEMBER_CHECK(PulseEffectAction, m_unkInt1, 0x3c);
...
GEODE_MEMBER_CHECK(CountTriggerAction, m_unk0, 0x0);
GEODE_MEMBER_CHECK(CountTriggerAction, m_previousCount, 0x4);
GEODE_MEMBER_CHECK(CountTriggerAction, m_targetCount, 0x8);
GEODE_MEMBER_CHECK(CountTriggerAction, m_targetGroup, 0xc);
GEODE_MEMBER_CHECK(CountTriggerAction, m_unk10, 0x10);
GEODE_MEMBER_CHECK(CountTriggerAction, m_unk14, 0x14);
GEODE_MEMBER_CHECK(CountTriggerAction, m_unk18, 0x18);
GEODE_MEMBER_CHECK(CountTriggerAction, m_itemID, 0x1c);
GEODE_MEMBER_CHECK(CountTriggerAction, m_multiActivate, 0x20);
GEODE_MEMBER_CHECK(CountTriggerAction, m_unkVecInt, 0x28);
