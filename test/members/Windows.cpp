...
GEODE_SIZE_CHECK(tk::spline, 0xa8);
GEODE_MEMBER_CHECK(tk::spline, m_x, 0x0);
GEODE_MEMBER_CHECK(tk::spline, m_y, 0x18);
GEODE_MEMBER_CHECK(tk::spline, m_b, 0x30);
GEODE_MEMBER_CHECK(tk::spline, m_c, 0x48);
GEODE_MEMBER_CHECK(tk::spline, m_d, 0x60);
GEODE_MEMBER_CHECK(tk::spline, m_c0, 0x78);
GEODE_MEMBER_CHECK(tk::spline, m_type, 0x80);
GEODE_MEMBER_CHECK(tk::spline, m_left, 0x84);
GEODE_MEMBER_CHECK(tk::spline, m_right, 0x88);
GEODE_MEMBER_CHECK(tk::spline, m_leftValue, 0x90);
GEODE_MEMBER_CHECK(tk::spline, m_rightValue, 0x98);
GEODE_MEMBER_CHECK(tk::spline, m_madeMonotonic, 0xa0);
