...
GEODE_MEMBER_CHECK(GJBaseGameLayer, m_flashNode, 0x31f0);
...
GEODE_SIZE_CHECK(EnterEffectInstance, 0xe8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_enterEffectAnimMap, 0x0);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_length, 0x10);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_lengthVariance, 0x14);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_offset, 0x18);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_offsetVariance, 0x1c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_offsetY, 0x20);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_offsetYVariance, 0x24);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_modFront, 0x28);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_modBack, 0x2c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_deadzone, 0x30);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveDistance, 0x34);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveDistanceVariance, 0x38);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveAngle, 0x3c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveAngleVariance, 0x40);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveX, 0x44);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveXVariance, 0x48);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveY, 0x4c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_moveYVariance, 0x50);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_relativeFade, 0x54);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_scaleX, 0x58);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_scaleXVariance, 0x5c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_scaleY, 0x60);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_scaleYVariance, 0x64);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_rotation, 0x68);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_rotationVariance, 0x6c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_tint, 0x70);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_unk074, 0x74);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_toOpacity, 0x78);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_fromOpacity, 0x7c);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_hsvValue, 0x80);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_hue, 0x90);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_saturation, 0x94);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_value, 0x98);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_gameObject, 0xa0);
...
GEODE_MEMBER_CHECK(EnterEffectInstance, m_easeIndices, 0xc8);
GEODE_MEMBER_CHECK(EnterEffectInstance, m_controlID, 0xe0);
...
GEODE_MEMBER_CHECK(GJGameState, m_cameraStepDiff, 0x32c);
...
GEODE_MEMBER_CHECK(GJGameState, m_enterEffectInstanceVectors, 0x3f8);
GEODE_MEMBER_CHECK(GJGameState, m_exitEffectInstanceVectors, 0x438);
GEODE_MEMBER_CHECK(GJGameState, m_enterChannelMap, 0x478);
GEODE_MEMBER_CHECK(GJGameState, m_exitChannelMap, 0x490);
GEODE_MEMBER_CHECK(GJGameState, m_moveEffectInstances, 0x4a8);
GEODE_MEMBER_CHECK(GJGameState, m_rotateEffectInstances, 0x4c0);
GEODE_MEMBER_CHECK(GJGameState, m_scaleEffectInstances, 0x4d8);
GEODE_MEMBER_CHECK(GJGameState, m_fadeEffectInstances, 0x4f0);
GEODE_MEMBER_CHECK(GJGameState, m_tintEffectInstances, 0x508);
GEODE_MEMBER_CHECK(GJGameState, m_unsortedAreaEffects, 0x520);
GEODE_MEMBER_CHECK(GJGameState, m_unkBool27, 0x560);
GEODE_MEMBER_CHECK(GJGameState, m_advanceFollowInstances, 0x568);
GEODE_MEMBER_CHECK(GJGameState, m_dynamicMoveActions, 0x580);
GEODE_MEMBER_CHECK(GJGameState, m_dynamicRotateActions, 0x598);
...
GEODE_MEMBER_CHECK(GJGameState, m_background, 0x6a4);
GEODE_MEMBER_CHECK(GJGameState, m_ground, 0x6a8);
GEODE_MEMBER_CHECK(GJGameState, m_middleground, 0x6ac);
GEODE_MEMBER_CHECK(GJGameState, m_unkBool31, 0x6b0);
GEODE_MEMBER_CHECK(GJGameState, m_points, 0x6b4);
...
GEODE_SIZE_CHECK(GJShaderState, 0x2c8);
GEODE_MEMBER_CHECK(GJShaderState, m_tweenActions, 0x0);
GEODE_MEMBER_CHECK(GJShaderState, m_tweenTimes, 0x40);
GEODE_MEMBER_CHECK(GJShaderState, m_time, 0x80);
GEODE_MEMBER_CHECK(GJShaderState, m_prevTime, 0x88);
GEODE_MEMBER_CHECK(GJShaderState, m_startTime, 0x90);
GEODE_MEMBER_CHECK(GJShaderState, m_textureScaleX, 0x98);
GEODE_MEMBER_CHECK(GJShaderState, m_textureScaleY, 0x9c);
GEODE_MEMBER_CHECK(GJShaderState, m_blurRefColor, 0xa0);
GEODE_MEMBER_CHECK(GJShaderState, m_blurIntensity, 0xa4);
GEODE_MEMBER_CHECK(GJShaderState, m_blurRefChannel, 0xa8);
GEODE_MEMBER_CHECK(GJShaderState, m_blurOnlyEmpty, 0xac);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveStartTime, 0xb0);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveTime, 0xb4);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveTimeOffset, 0xb8);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveSpeed, 0xbc);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveThickness, 0xc0);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveStrength, 0xc4);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveWidth, 0xc8);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveFadeIn, 0xcc);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveFadeOut, 0xd0);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveInvert, 0xd4);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveInner, 0xd8);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveOuter, 0xdc);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveTargetID, 0xe0);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveTarget, 0xe4);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveCenterMoving, 0xe5);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveRelative, 0xe6);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveMaxSize, 0xe8);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveScreenOffset, 0xec);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveCenterDirty, 0xf4);
GEODE_MEMBER_CHECK(GJShaderState, m_shockWaveCenter, 0xf8);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineStartTime, 0x100);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineTime, 0x108);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineTimeOffset, 0x10c);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineSpeed, 0x110);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineAxis, 0x114);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineDirection, 0x115);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineDual, 0x116);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineInvert, 0x117);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineScreenOffset, 0x118);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineStrength, 0x11c);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineWidth, 0x120);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineFadeIn, 0x124);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineFadeOut, 0x128);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineThickness, 0x12c);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineTargetID, 0x130);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineTarget, 0x134);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineCenterMoving, 0x135);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineRelative, 0x136);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineMaxSize, 0x138);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineScreenOffset2, 0x13c);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineCenterDirty, 0x144);
GEODE_MEMBER_CHECK(GJShaderState, m_shockLineCenter, 0x148);
GEODE_MEMBER_CHECK(GJShaderState, m_glitchStrength, 0x150);
GEODE_MEMBER_CHECK(GJShaderState, m_glitchSpeed, 0x154);
GEODE_MEMBER_CHECK(GJShaderState, m_glitchSliceHeight, 0x158);
GEODE_MEMBER_CHECK(GJShaderState, m_glitchMaxSliceXOff, 0x15c);
GEODE_MEMBER_CHECK(GJShaderState, m_glitchMaxColXOff, 0x160);
GEODE_MEMBER_CHECK(GJShaderState, m_glitchMaxColYOff, 0x164);
GEODE_MEMBER_CHECK(GJShaderState, m_glitchRelative, 0x168);
GEODE_MEMBER_CHECK(GJShaderState, m_chromaticTargetX, 0x16c);
GEODE_MEMBER_CHECK(GJShaderState, m_chromaticTargetY, 0x170);
GEODE_MEMBER_CHECK(GJShaderState, m_chromaticRelative, 0x174);
GEODE_MEMBER_CHECK(GJShaderState, m_cGStartTime, 0x178);
GEODE_MEMBER_CHECK(GJShaderState, m_cGTime, 0x17c);
GEODE_MEMBER_CHECK(GJShaderState, m_cGSpeed, 0x180);
GEODE_MEMBER_CHECK(GJShaderState, m_cGRGBOffset, 0x184);
GEODE_MEMBER_CHECK(GJShaderState, m_cGStrength, 0x188);
GEODE_MEMBER_CHECK(GJShaderState, m_cGSegmentHeight, 0x18c);
GEODE_MEMBER_CHECK(GJShaderState, m_cGLineThickness, 0x190);
GEODE_MEMBER_CHECK(GJShaderState, m_cGLineStrength, 0x194);
GEODE_MEMBER_CHECK(GJShaderState, m_cGEnable, 0x198);
GEODE_MEMBER_CHECK(GJShaderState, m_cGActive, 0x199);
GEODE_MEMBER_CHECK(GJShaderState, m_cGRelative, 0x19a);
GEODE_MEMBER_CHECK(GJShaderState, m_cGRelativePos, 0x19b);
GEODE_MEMBER_CHECK(GJShaderState, m_pixelateTargetX, 0x19c);
GEODE_MEMBER_CHECK(GJShaderState, m_pixelateTargetY, 0x1a0);
GEODE_MEMBER_CHECK(GJShaderState, m_pixelateSnapGrid, 0x1a4);
GEODE_MEMBER_CHECK(GJShaderState, m_pixelatePixelating, 0x1a5);
GEODE_MEMBER_CHECK(GJShaderState, m_pixelateRelative, 0x1a6);
GEODE_MEMBER_CHECK(GJShaderState, m_pixelateHardEdges, 0x1a7);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleSize, 0x1a8);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleFade, 0x1ac);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleStrength, 0x1b0);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleTargetID, 0x1b4);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleTintChannel, 0x1b8);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleRelative, 0x1bc);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleAdditive, 0x1bd);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleTint, 0x1be);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleCenter, 0x1c4);
GEODE_MEMBER_CHECK(GJShaderState, m_lensCircleScreenOffset, 0x1cc);
GEODE_MEMBER_CHECK(GJShaderState, m_radialBlurSize, 0x1d4);
GEODE_MEMBER_CHECK(GJShaderState, m_radialBlurFade, 0x1d8);
GEODE_MEMBER_CHECK(GJShaderState, m_radialBlurTarget, 0x1dc);
GEODE_MEMBER_CHECK(GJShaderState, m_radialBlurTargetID, 0x1e0);
GEODE_MEMBER_CHECK(GJShaderState, m_radialBlurCenter, 0x1e4);
GEODE_MEMBER_CHECK(GJShaderState, m_radialBlurScreenOffset, 0x1ec);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurTargetX, 0x1f4);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurTargetY, 0x1f8);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurSpeedX, 0x1fc);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurSpeedY, 0x200);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurFollowEaseX, 0x204);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurFollowEaseY, 0x208);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurTargetIDX, 0x20c);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurTargetIDY, 0x210);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurDual, 0x214);
GEODE_MEMBER_CHECK(GJShaderState, m_motionBlurRelative, 0x215);
GEODE_MEMBER_CHECK(GJShaderState, m_bulgeValue, 0x218);
GEODE_MEMBER_CHECK(GJShaderState, m_bulgeRelative, 0x21c);
GEODE_MEMBER_CHECK(GJShaderState, m_bulgeTargetID, 0x220);
GEODE_MEMBER_CHECK(GJShaderState, m_bulgeRadius, 0x224);
GEODE_MEMBER_CHECK(GJShaderState, m_bulgeCenter, 0x228);
GEODE_MEMBER_CHECK(GJShaderState, m_bulgeScreenOffset, 0x230);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchTargetX, 0x238);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchTargetY, 0x23c);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchTargetEnabledX, 0x240);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchTargetEnabledY, 0x241);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchTargetIDX, 0x244);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchTargetIDY, 0x248);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchCenter, 0x24c);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchScreenOffset, 0x254);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchRelative, 0x25c);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchRadius, 0x260);
GEODE_MEMBER_CHECK(GJShaderState, m_pinchModifier, 0x264);
GEODE_MEMBER_CHECK(GJShaderState, m_grayscaleValue, 0x26c);
GEODE_MEMBER_CHECK(GJShaderState, m_grayscaleUseLum, 0x270);
GEODE_MEMBER_CHECK(GJShaderState, m_grayscaleTintChannel, 0x274);
GEODE_MEMBER_CHECK(GJShaderState, m_grayscaleTint, 0x278);
GEODE_MEMBER_CHECK(GJShaderState, m_sepiaValue, 0x27c);
GEODE_MEMBER_CHECK(GJShaderState, m_invertColorEditRGB, 0x280);
GEODE_MEMBER_CHECK(GJShaderState, m_invertColorR, 0x284);
GEODE_MEMBER_CHECK(GJShaderState, m_invertColorG, 0x288);
GEODE_MEMBER_CHECK(GJShaderState, m_invertColorB, 0x28c);
GEODE_MEMBER_CHECK(GJShaderState, m_invertColorClampRGB, 0x290);
GEODE_MEMBER_CHECK(GJShaderState, m_hueShiftDegrees, 0x294);
GEODE_MEMBER_CHECK(GJShaderState, m_colorChangeCR, 0x298);
GEODE_MEMBER_CHECK(GJShaderState, m_colorChangeCG, 0x29c);
GEODE_MEMBER_CHECK(GJShaderState, m_colorChangeCB, 0x2a0);
GEODE_MEMBER_CHECK(GJShaderState, m_colorChangeBR, 0x2a4);
GEODE_MEMBER_CHECK(GJShaderState, m_colorChangeBG, 0x2a8);
GEODE_MEMBER_CHECK(GJShaderState, m_colorChangeBB, 0x2ac);
GEODE_MEMBER_CHECK(GJShaderState, m_splitTargetRows, 0x2b0);
GEODE_MEMBER_CHECK(GJShaderState, m_splitTargetCols, 0x2b4);
GEODE_MEMBER_CHECK(GJShaderState, m_splitActive, 0x2b8);
GEODE_MEMBER_CHECK(GJShaderState, m_minBlendingLayer, 0x2bc);
GEODE_MEMBER_CHECK(GJShaderState, m_maxBlendingLayer, 0x2c0);
GEODE_MEMBER_CHECK(GJShaderState, m_zLayerDirty, 0x2c4);
GEODE_MEMBER_CHECK(GJShaderState, m_noPlayerParticles, 0x2c5);
GEODE_MEMBER_CHECK(GJShaderState, m_usesShaders, 0x2c6);
...
GEODE_MEMBER_CHECK(PlayerObject, m_switchWaveTrailColor, 0x82a);
GEODE_MEMBER_CHECK(PlayerObject, m_practiceDeathEffect, 0x82b);
...
GEODE_MEMBER_CHECK(TextArea, m_disableColor, 0x258);
GEODE_MEMBER_CHECK(TextArea, m_label, 0x260);
GEODE_MEMBER_CHECK(TextArea, m_width, 0x268);
GEODE_MEMBER_CHECK(TextArea, m_unknown, 0x26c);
GEODE_MEMBER_CHECK(TextArea, m_fontFile, 0x270);
GEODE_MEMBER_CHECK(TextArea, m_height, 0x290);
GEODE_MEMBER_CHECK(TextArea, m_unkBool, 0x294);
GEODE_MEMBER_CHECK(TextArea, m_anchorPoint, 0x298);
GEODE_MEMBER_CHECK(TextArea, m_allShown, 0x2a0);
GEODE_MEMBER_CHECK(TextArea, m_scale, 0x2a4);
GEODE_MEMBER_CHECK(TextArea, m_rectHeight, 0x2a8);
GEODE_MEMBER_CHECK(TextArea, m_rectWidth, 0x2ac);
GEODE_MEMBER_CHECK(TextArea, m_maxWidth, 0x2b0);
GEODE_MEMBER_CHECK(TextArea, m_unkPoint, 0x2b4);
...
GEODE_MEMBER_CHECK(FMODAudioEngine, m_fmodMusic, 0x140);
...
GEODE_MEMBER_CHECK(FMODAudioEngine, m_reverbChannel, 0x250);
...
GEODE_SIZE_CHECK(FMODSoundState, 0xc0);
GEODE_MEMBER_CHECK(FMODSoundState, m_filePath, 0x0);
GEODE_MEMBER_CHECK(FMODSoundState, m_speed, 0x20);
GEODE_MEMBER_CHECK(FMODSoundState, m_unkFloat1, 0x24);
GEODE_MEMBER_CHECK(FMODSoundState, m_volume, 0x28);
GEODE_MEMBER_CHECK(FMODSoundState, m_shouldLoop, 0x2c);
GEODE_MEMBER_CHECK(FMODSoundState, m_channelID, 0x30);
GEODE_MEMBER_CHECK(FMODSoundState, m_soundStateContainer, 0x38);
GEODE_MEMBER_CHECK(FMODSoundState, m_uniqueID, 0xa0);
GEODE_MEMBER_CHECK(FMODSoundState, m_sfxGroup, 0xa4);
GEODE_MEMBER_CHECK(FMODSoundState, m_pitch, 0xa8);
GEODE_MEMBER_CHECK(FMODSoundState, m_fastFourierTransform, 0xac);
GEODE_MEMBER_CHECK(FMODSoundState, m_reverb, 0xad);
GEODE_MEMBER_CHECK(FMODSoundState, m_effectID, 0xb0);
GEODE_MEMBER_CHECK(FMODSoundState, m_isMusic, 0xb4);
GEODE_MEMBER_CHECK(FMODSoundState, m_musicID, 0xb8);
GEODE_MEMBER_CHECK(FMODSoundState, m_unkBool2, 0xbc);
...
GEODE_MEMBER_CHECK(FMODAudioState, m_tweensForEffectGroups, 0x18);
GEODE_MEMBER_CHECK(FMODAudioState, m_tweensForMusicChannels, 0x28);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForEffectChannels, 0x38);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeModForEffectChannels, 0x78);
GEODE_MEMBER_CHECK(FMODAudioState, m_pitchForEffectChannels, 0xb8);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForEffectGroups, 0xf8);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeModForEffectGroups, 0x138);
GEODE_MEMBER_CHECK(FMODAudioState, m_pitchForEffectGroups, 0x178);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeForMusicChannels, 0x1b8);
GEODE_MEMBER_CHECK(FMODAudioState, m_volumeModForMusicChannels, 0x1f8);
GEODE_MEMBER_CHECK(FMODAudioState, m_pitchForMusicChannels, 0x238);
GEODE_MEMBER_CHECK(FMODAudioState, m_intervalForEffects, 0x278);
GEODE_MEMBER_CHECK(FMODAudioState, m_queuedMusicForChannels1, 0x2b8);
GEODE_MEMBER_CHECK(FMODAudioState, m_queuedMusicForChannels2, 0x2f8);
GEODE_MEMBER_CHECK(FMODAudioState, m_soundStateForChannels, 0x338);
GEODE_MEMBER_CHECK(FMODAudioState, m_unkUint64_1, 0x378);

GEODE_SIZE_CHECK(PlayerCheckpoint, 0x1d0);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_position, 0x140);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_lastPosition, 0x148);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_yVelocity, 0x150);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isUpsideDown, 0x154);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isSideways, 0x155);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isShip, 0x156);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isBall, 0x157);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isBird, 0x158);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isSwing, 0x159);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isDart, 0x15a);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isRobot, 0x15b);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isSpider, 0x15c);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_isOnGround, 0x15d);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_ghostType, 0x160);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_miniMode, 0x164);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_speed, 0x168);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_hidden, 0x16c);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_goingLeft, 0x16d);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_reverseSpeed, 0x170);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_dashing, 0x174);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_dashX, 0x178);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_dashY, 0x17c);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_dashAngle, 0x180);
GEODE_MEMBER_CHECK(PlayerCheckpoint, m_dashStartTime, 0x184);
...
GEODE_MEMBER_CHECK(EffectManagerState, m_unorderedMapInt_vectorCountTriggerAction, 0x70);
GEODE_MEMBER_CHECK(EffectManagerState, m_unorderedSet_int1, 0xb0);
GEODE_MEMBER_CHECK(EffectManagerState, m_mapInt_Int, 0xf0);
GEODE_MEMBER_CHECK(EffectManagerState, m_unorderedMapInt_OpacityEffectAction, 0x100);
...
GEODE_MEMBER_CHECK(EffectManagerState, m_unorderedMapInt_bool, 0x1e0);
GEODE_MEMBER_CHECK(EffectManagerState, m_vectorGroupCommandObject2, 0x220);
GEODE_MEMBER_CHECK(EffectManagerState, m_unorderedMapInt_pair_double_double, 0x238);
...
GEODE_MEMBER_CHECK(CheckpointObject, m_unke78, 0xe68);
GEODE_MEMBER_CHECK(CheckpointObject, m_unke7c, 0xe6c);
GEODE_MEMBER_CHECK(CheckpointObject, m_unke80, 0xe70);
GEODE_MEMBER_CHECK(CheckpointObject, m_ground2Invisible, 0xe74);
GEODE_MEMBER_CHECK(CheckpointObject, m_streakBlend, 0xe75);
GEODE_MEMBER_CHECK(CheckpointObject, m_uniqueID, 0xe78);
GEODE_MEMBER_CHECK(CheckpointObject, m_respawnID, 0xe7c);
GEODE_MEMBER_CHECK(CheckpointObject, m_vectorSavedObjectStateRef, 0xe80);
GEODE_MEMBER_CHECK(CheckpointObject, m_vectorActiveSaveObjectState, 0xe98);
GEODE_MEMBER_CHECK(CheckpointObject, m_vectorSpecialSaveObjectState, 0xeb0);
...
GEODE_SIZE_CHECK(LevelAreaInnerLayer, 0x1b8);
GEODE_MEMBER_CHECK(LevelAreaInnerLayer, m_exiting, 0x1b0);
...
GEODE_SIZE_CHECK(SetupEnterEffectPopup, 0x3f0);
GEODE_SIZE_CHECK(FMODLevelVisualizer, 0x148);
GEODE_SIZE_CHECK(ShareLevelLayer, 0x298);
GEODE_SIZE_CHECK(StatsLayer, 0x260);
GEODE_SIZE_CHECK(HSVLiveOverlay, 0x2c0);
GEODE_SIZE_CHECK(ShareLevelSettingsLayer, 0x2a0);
GEODE_SIZE_CHECK(SetupAreaRotateTriggerPopup, 0x3b8);
GEODE_SIZE_CHECK(GJSearchObject, 0x1d8);
GEODE_SIZE_CHECK(LevelLeaderboard, 0x2d0);
GEODE_SIZE_CHECK(TextAlertPopup, 0x150);
GEODE_SIZE_CHECK(TutorialLayer, 0x298);
GEODE_SIZE_CHECK(FLAlertLayer, 0x278);
GEODE_SIZE_CHECK(GJOptionsLayer, 0x3f0);
GEODE_SIZE_CHECK(SetupCameraEdgePopup, 0x3c0);
GEODE_SIZE_CHECK(GJMapPack, 0x1a8);
GEODE_SIZE_CHECK(FriendsProfilePage, 0x2d8);
GEODE_SIZE_CHECK(SetupAreaMoveTriggerPopup, 0x3b8);
GEODE_SIZE_CHECK(AchievementNotifier, 0x158);
GEODE_SIZE_CHECK(SongSelectNode, 0x1b0);
GEODE_SIZE_CHECK(CameraTriggerGameObject, 0x760);
GEODE_SIZE_CHECK(GameLevelOptionsLayer, 0x3f8);
GEODE_SIZE_CHECK(SecretNumberLayer, 0x198);
GEODE_SIZE_CHECK(SFXInfoObject, 0x70);
GEODE_SIZE_CHECK(PlayLayer, 0x3a88);
GEODE_SIZE_CHECK(RewardUnlockLayer, 0x2c8);
GEODE_SIZE_CHECK(CCAnimateFrameCache, 0x50);
GEODE_SIZE_CHECK(SecretRewardsLayer, 0x258);
GEODE_SIZE_CHECK(GJRequestCell, 0x260);
GEODE_SIZE_CHECK(GameLevelManager, 0x3d0);
GEODE_SIZE_CHECK(KeyframeGameObject, 0x778);
GEODE_SIZE_CHECK(RateLevelLayer, 0x298);
GEODE_SIZE_CHECK(GauntletNode, 0x168);
GEODE_SIZE_CHECK(EditGameObjectPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupKeyframeAnimPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupRandTriggerPopup, 0x3d8);
GEODE_SIZE_CHECK(GJUserScore, 0x398);
GEODE_SIZE_CHECK(GJMultiplayerManager, 0x170);
GEODE_SIZE_CHECK(SetupRotateGameplayPopup, 0x3a8);
GEODE_SIZE_CHECK(MenuLayer, 0x1e0);
GEODE_SIZE_CHECK(AccountRegisterLayer, 0x2f0);
GEODE_SIZE_CHECK(CCMenuItemSpriteExtra, 0x208);
GEODE_SIZE_CHECK(SetupPersistentItemTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(EndLevelLayer, 0x2b0);
GEODE_SIZE_CHECK(GJPathSprite, 0x260);
GEODE_SIZE_CHECK(CreatorLayer, 0x1c0);
GEODE_SIZE_CHECK(AchievementManager, 0x188);
GEODE_SIZE_CHECK(GradientTriggerObject, 0x768);
GEODE_SIZE_CHECK(CCCounterLabel, 0x238);
GEODE_SIZE_CHECK(GJLevelScoreCell, 0x238);
GEODE_SIZE_CHECK(SetupAnimSettingsPopup, 0x3a8);
GEODE_SIZE_CHECK(DailyLevelPage, 0x2c8);
GEODE_SIZE_CHECK(SpriteDescription, 0x68);
GEODE_SIZE_CHECK(SetupAreaTransformTriggerPopup, 0x3b8);
GEODE_SIZE_CHECK(FRequestProfilePage, 0x320);
GEODE_SIZE_CHECK(SetupTransformPopup, 0x3a8);
GEODE_SIZE_CHECK(EditLevelLayer, 0x210);
GEODE_SIZE_CHECK(CCBlockLayer, 0x228);
GEODE_SIZE_CHECK(CommentCell, 0x260);
GEODE_SIZE_CHECK(TextArea, 0x2d8);
GEODE_SIZE_CHECK(AchievementCell, 0x230);
GEODE_SIZE_CHECK(BoomListView, 0x1d0);
GEODE_SIZE_CHECK(MoreVideoOptionsLayer, 0x2c0);
GEODE_SIZE_CHECK(CheckpointGameObject, 0x748);
GEODE_SIZE_CHECK(GJSmartBlockPreview, 0x178);
GEODE_SIZE_CHECK(UndoObject, 0xa0);
GEODE_SIZE_CHECK(SetupResetTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupEndPopup, 0x3c0);
GEODE_SIZE_CHECK(SetupAreaTriggerPopup, 0x3b8);
GEODE_SIZE_CHECK(CCLightFlash, 0x168);
GEODE_SIZE_CHECK(UISaveLoadLayer, 0x3b0);
GEODE_SIZE_CHECK(UploadListPopup, 0x2a0);
GEODE_SIZE_CHECK(ExplodeItemSprite, 0x278);
GEODE_SIZE_CHECK(SetupShaderEffectPopup, 0x3c0);
GEODE_SIZE_CHECK(SFXSearchResult, 0xa0);
GEODE_SIZE_CHECK(LevelPage, 0x240);
GEODE_SIZE_CHECK(CollisionBlockPopup, 0x2a0);
GEODE_SIZE_CHECK(CCNodeContainer, 0x140);
GEODE_SIZE_CHECK(URLViewLayer, 0x268);
GEODE_SIZE_CHECK(LevelAreaLayer, 0x1b8);
GEODE_SIZE_CHECK(SliderTouchLogic, 0x1e8);
GEODE_SIZE_CHECK(EnterEffectObject, 0x828);
GEODE_SIZE_CHECK(SetupTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(SelectPremadeLayer, 0x280);
GEODE_SIZE_CHECK(SetupSFXPopup, 0x3d8);
GEODE_SIZE_CHECK(GJTransformControl, 0x230);
GEODE_SIZE_CHECK(GJScaleControl, 0x210);
GEODE_SIZE_CHECK(SetupKeyframePopup, 0x3c0);
GEODE_SIZE_CHECK(SetupMGTrigger, 0x3f8);
GEODE_SIZE_CHECK(GJLocalLevelScoreCell, 0x238);
GEODE_SIZE_CHECK(GJChallengeItem, 0x90);
GEODE_SIZE_CHECK(SetupShakePopup, 0x3f0);
GEODE_SIZE_CHECK(EndTriggerGameObject, 0x748);
GEODE_SIZE_CHECK(AudioLineGuideGameObject, 0x750);
GEODE_SIZE_CHECK(SecretLayer5, 0x290);
GEODE_SIZE_CHECK(SecretLayer2, 0x208);
GEODE_SIZE_CHECK(SecretLayer3, 0x1d0);
GEODE_SIZE_CHECK(SecretLayer4, 0x1f0);
GEODE_SIZE_CHECK(GauntletSprite, 0x148);
GEODE_SIZE_CHECK(TextStyleSection, 0x58);
GEODE_SIZE_CHECK(AudioAssetsBrowser, 0x2d8);
GEODE_SIZE_CHECK(SongOptionsLayer, 0x290);
GEODE_SIZE_CHECK(LevelSettingsObject, 0x1d8);
GEODE_SIZE_CHECK(ShareListLayer, 0x290);
GEODE_SIZE_CHECK(SelectListIconLayer, 0x290);
GEODE_SIZE_CHECK(UploadPopup, 0x2a0);
GEODE_SIZE_CHECK(LoadingCircle, 0x238);
GEODE_SIZE_CHECK(NewgroundsInfoLayer, 0x280);
GEODE_SIZE_CHECK(AchievementsLayer, 0x288);
GEODE_SIZE_CHECK(CreateMenuItem, 0x238);
GEODE_SIZE_CHECK(SetupPulsePopup, 0x4f8);
...
GEODE_SIZE_CHECK(SelectSFXSortLayer, 0x288);
GEODE_SIZE_CHECK(GJStoreItem, 0x178);
GEODE_SIZE_CHECK(GJRobotSprite, 0x328);
GEODE_SIZE_CHECK(SetupTimerEventTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupArtSwitchPopup, 0x3c0);
GEODE_SIZE_CHECK(CheckpointObject, 0x1260);
GEODE_SIZE_CHECK(ButtonPage, 0x198);
GEODE_SIZE_CHECK(CCLightStrip, 0x160);
GEODE_SIZE_CHECK(CCSpriteWithHue, 0x298);
GEODE_SIZE_CHECK(GJAccountManager, 0x1f0);
GEODE_SIZE_CHECK(SetupSpawnParticlePopup, 0x3a8);
GEODE_SIZE_CHECK(ArtistCell, 0x238);
GEODE_SIZE_CHECK(SimplePlayer, 0x2a8);
GEODE_SIZE_CHECK(GJMGLayer, 0x1e8);
GEODE_SIZE_CHECK(DashRingObject, 0x758);
GEODE_SIZE_CHECK(PlayerControlGameObject, 0x748);
GEODE_SIZE_CHECK(UIObjectSettingsPopup, 0x3a8);
GEODE_SIZE_CHECK(LoadingLayer, 0x1c8);
GEODE_SIZE_CHECK(MessagesProfilePage, 0x328);
GEODE_SIZE_CHECK(UpdateAccountSettingsPopup, 0x2a8);
GEODE_SIZE_CHECK(ShaderGameObject, 0x790);
GEODE_SIZE_CHECK(TriggerControlGameObject, 0x768);
GEODE_SIZE_CHECK(EditorOptionsLayer, 0x408);
GEODE_SIZE_CHECK(GJWriteMessagePopup, 0x318);
GEODE_SIZE_CHECK(StatsCell, 0x230);
GEODE_SIZE_CHECK(LevelSelectLayer, 0x1d8);
GEODE_SIZE_CHECK(SecretLayer, 0x1e8);
GEODE_SIZE_CHECK(CCMenuItemToggler, 0x190);
GEODE_SIZE_CHECK(SetupObjectControlPopup, 0x3a8);
GEODE_SIZE_CHECK(CustomSongCell, 0x248);
GEODE_SIZE_CHECK(SpecialAnimGameObject, 0x5c0);
GEODE_SIZE_CHECK(GJFollowCommandLayer, 0x408);
GEODE_SIZE_CHECK(SetupInteractObjectPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupDashRingPopup, 0x3a8);
GEODE_SIZE_CHECK(TOSPopup, 0x278);
GEODE_SIZE_CHECK(SetupAreaFadeTriggerPopup, 0x3b8);
GEODE_SIZE_CHECK(OptionsObject, 0x70);
GEODE_SIZE_CHECK(GJPathRewardPopup, 0x280);
GEODE_SIZE_CHECK(SetFolderPopup, 0x2c0);
GEODE_SIZE_CHECK(TeleportPortalObject, 0x788);
GEODE_SIZE_CHECK(SetupAdvFollowEditPhysicsPopup, 0x3a8);
...
GEODE_SIZE_CHECK(SongInfoLayer, 0x300);
GEODE_SIZE_CHECK(GameObject, 0x550);
GEODE_SIZE_CHECK(GJSongBrowser, 0x2b0);
GEODE_SIZE_CHECK(EditButtonBar, 0x168);
GEODE_SIZE_CHECK(LevelBrowserLayer, 0x320);
GEODE_SIZE_CHECK(MenuGameLayer, 0x1d0);
GEODE_SIZE_CHECK(CCURLObject, 0x78);
GEODE_SIZE_CHECK(CustomMusicCell, 0x248);
GEODE_SIZE_CHECK(CCSpritePart, 0x2a0);
GEODE_SIZE_CHECK(ArtTriggerGameObject, 0x748);
GEODE_SIZE_CHECK(ParticlePreviewLayer, 0x238);
GEODE_SIZE_CHECK(RewardsPage, 0x2b8);
GEODE_SIZE_CHECK(MoreOptionsLayer, 0x2e0);
GEODE_SIZE_CHECK(FontObject, 0x4e8);
GEODE_SIZE_CHECK(CCPartAnimSprite, 0x280);
GEODE_SIZE_CHECK(AdvancedFollowTriggerObject, 0x838);
GEODE_SIZE_CHECK(SetupPickupTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(SearchSFXPopup, 0x2b8);
GEODE_SIZE_CHECK(GJLevelList, 0x248);
GEODE_SIZE_CHECK(UIPOptionsLayer, 0x3c8);
GEODE_SIZE_CHECK(SetupItemCompareTriggerPopup, 0x3b0);
GEODE_SIZE_CHECK(GJUserCell, 0x258);
GEODE_SIZE_CHECK(FindBPMLayer, 0x300);
GEODE_SIZE_CHECK(InheritanceNode, 0x58);
GEODE_SIZE_CHECK(GJSmartTemplate, 0xd0);
GEODE_SIZE_CHECK(SetupOptionsTriggerPopup, 0x3b8);
GEODE_SIZE_CHECK(EditTriggersPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupPlatformerEndPopup, 0x3a8);
GEODE_SIZE_CHECK(FollowRewardPage, 0x2a0);
GEODE_SIZE_CHECK(LevelListCell, 0x240);
GEODE_SIZE_CHECK(SetupRandAdvTriggerPopup, 0x3d0);
GEODE_SIZE_CHECK(CountTriggerGameObject, 0x750);
GEODE_SIZE_CHECK(EffectGameObject, 0x740);
GEODE_SIZE_CHECK(MusicSearchResult, 0x90);
GEODE_SIZE_CHECK(ItemTriggerGameObject, 0x778);
GEODE_SIZE_CHECK(ColorSelectPopup, 0x4c0);
GEODE_SIZE_CHECK(CCIndexPath, 0x40);
GEODE_SIZE_CHECK(SmartGameObject, 0x598);
GEODE_SIZE_CHECK(UISettingsGameObject, 0x750);
GEODE_SIZE_CHECK(SliderThumb, 0x198);
GEODE_SIZE_CHECK(GJItemIcon, 0x278);
GEODE_SIZE_CHECK(DungeonBarsSprite, 0x148);
GEODE_SIZE_CHECK(GameManager, 0x668);
GEODE_SIZE_CHECK(SetupAdvFollowPopup, 0x3b0);
GEODE_SIZE_CHECK(GJComment, 0x1d8);
GEODE_SIZE_CHECK(SetupInstantCountPopup, 0x3f0);
GEODE_SIZE_CHECK(ListButtonPage, 0x198);
GEODE_SIZE_CHECK(OptionsCell, 0x238);
GEODE_SIZE_CHECK(GJAccountSettingsLayer, 0x2c0);
GEODE_SIZE_CHECK(OptionsLayer, 0x298);
GEODE_SIZE_CHECK(StarInfoPopup, 0x278);
GEODE_SIZE_CHECK(LikeItemLayer, 0x290);
GEODE_SIZE_CHECK(SetupStaticCameraPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupForceBlockPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupCountTriggerPopup, 0x3d0);
GEODE_SIZE_CHECK(GJRotationControl, 0x1c8);
GEODE_SIZE_CHECK(GJDifficultySprite, 0x260);
GEODE_SIZE_CHECK(CCSpriteGrayscale, 0x298);
GEODE_SIZE_CHECK(PlayerFireBoostSprite, 0x260);
GEODE_SIZE_CHECK(MoreSearchLayer, 0x2c8);
GEODE_SIZE_CHECK(GJMessageCell, 0x260);
GEODE_SIZE_CHECK(SetupCameraGuidePopup, 0x3a8);
GEODE_SIZE_CHECK(SetupMoveCommandPopup, 0x3b0);
GEODE_SIZE_CHECK(SetupTimerTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(CustomizeObjectLayer, 0x388);
GEODE_SIZE_CHECK(DemonFilterSelectLayer, 0x298);
GEODE_SIZE_CHECK(NCSInfoLayer, 0x288);
GEODE_SIZE_CHECK(FriendRequestPopup, 0x2b8);
GEODE_SIZE_CHECK(cocos2d::CCGLProgram, 0x78);
GEODE_SIZE_CHECK(GJGradientLayer, 0x260);
GEODE_SIZE_CHECK(SetupEnterTriggerPopup, 0x3c0);
GEODE_SIZE_CHECK(EditorPauseLayer, 0x270);
GEODE_SIZE_CHECK(LevelAreaInnerLayer, 0x1b8);
GEODE_SIZE_CHECK(LevelListLayer, 0x3d8);
GEODE_SIZE_CHECK(ProfilePage, 0x358);
GEODE_SIZE_CHECK(KeybindingsManager, 0x150);
GEODE_SIZE_CHECK(SupportLayer, 0x280);
GEODE_SIZE_CHECK(PurchaseItemPopup, 0x288);
GEODE_SIZE_CHECK(SongTriggerGameObject, 0x7f0);
GEODE_SIZE_CHECK(SetupAudioLineGuidePopup, 0x3b8);
GEODE_SIZE_CHECK(MusicDownloadManager, 0x260);
GEODE_SIZE_CHECK(LevelCell, 0x268);
GEODE_SIZE_CHECK(LevelInfoLayer, 0x2d8);
GEODE_SIZE_CHECK(GJObjectDecoder, 0x148);
GEODE_SIZE_CHECK(CharacterColorPage, 0x2c0);
GEODE_SIZE_CHECK(GJSmartBlockPreviewSprite, 0x140);
GEODE_SIZE_CHECK(SFXFolderObject, 0x78);
GEODE_SIZE_CHECK(SetupCameraModePopup, 0x3e8);
GEODE_SIZE_CHECK(GJPromoPopup, 0x298);
GEODE_SIZE_CHECK(SetupRotateCommandPopup, 0x3a8);
GEODE_SIZE_CHECK(SequenceTriggerGameObject, 0x7f0);
GEODE_SIZE_CHECK(ScrollingLayer, 0x260);
GEODE_SIZE_CHECK(GameObjectCopy, 0x60);
GEODE_SIZE_CHECK(GJActionManager, 0x148);
GEODE_SIZE_CHECK(cocos2d::extension::CCHttpRequest, 0xe0);
GEODE_SIZE_CHECK(CreateParticlePopup, 0x3b0);
GEODE_SIZE_CHECK(ConfigureHSVWidget, 0x1a8);
GEODE_SIZE_CHECK(GJDropDownLayer, 0x260);
GEODE_SIZE_CHECK(GJUINode, 0x188);
GEODE_SIZE_CHECK(AchievementBar, 0x1a0);
GEODE_SIZE_CHECK(GJGroundLayer, 0x1d8);
GEODE_SIZE_CHECK(ColorChannelSprite, 0x270);
GEODE_SIZE_CHECK(SetupSongTriggerPopup, 0x3c8);
GEODE_SIZE_CHECK(ChallengesPage, 0x2c0);
GEODE_SIZE_CHECK(UILayer, 0x280);
GEODE_SIZE_CHECK(GraphicsReloadLayer, 0x1a8);
GEODE_SIZE_CHECK(GJFriendRequest, 0x198);
GEODE_SIZE_CHECK(SetupObjectTogglePopup, 0x3a8);
GEODE_SIZE_CHECK(ShareCommentLayer, 0x310);
GEODE_SIZE_CHECK(AccountLayer, 0x2d0);
GEODE_SIZE_CHECK(SetupCheckpointPopup, 0x3a8);
GEODE_SIZE_CHECK(EnhancedGameObject, 0x5b8);
GEODE_SIZE_CHECK(SetupTouchTogglePopup, 0x3e8);
GEODE_SIZE_CHECK(CCTextInputNode, 0x268);
GEODE_SIZE_CHECK(ListButtonBar, 0x160);
GEODE_SIZE_CHECK(LoadingCircleSprite, 0x258);
GEODE_SIZE_CHECK(BitmapFontCache, 0x40);
GEODE_SIZE_CHECK(BrowseSmartTemplateLayer, 0x2a8);
GEODE_SIZE_CHECK(GJGarageLayer, 0x260);
GEODE_SIZE_CHECK(LeaderboardsLayer, 0x200);
GEODE_SIZE_CHECK(GJCommentListLayer, 0x228);
GEODE_SIZE_CHECK(SetupAreaTintTriggerPopup, 0x3e0);
GEODE_SIZE_CHECK(SetupTimeWarpPopup, 0x3c0);
GEODE_SIZE_CHECK(RandTriggerGameObject, 0x758);
GEODE_SIZE_CHECK(ButtonSprite, 0x2c0);
GEODE_SIZE_CHECK(TableViewCell, 0x230);
GEODE_SIZE_CHECK(KeyframeAnimTriggerObject, 0x758);
GEODE_SIZE_CHECK(GameOptionsLayer, 0x400);
GEODE_SIZE_CHECK(GJChestSprite, 0x268);
GEODE_SIZE_CHECK(TopArtistsLayer, 0x2d0);
GEODE_SIZE_CHECK(SetupObjectOptions2Popup, 0x3a8);
GEODE_SIZE_CHECK(SetupCameraOffsetTrigger, 0x420);
GEODE_SIZE_CHECK(GauntletSelectLayer, 0x208);
GEODE_SIZE_CHECK(ExplodeItemNode, 0x160);
GEODE_SIZE_CHECK(TimerTriggerGameObject, 0x760);
GEODE_SIZE_CHECK(GJGameLoadingLayer, 0x1a8);
GEODE_SIZE_CHECK(SetupGameplayOffsetPopup, 0x3a8);
GEODE_SIZE_CHECK(CustomSFXCell, 0x248);
GEODE_SIZE_CHECK(SetupInstantCollisionTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(SetupReverbPopup, 0x3b0);
GEODE_SIZE_CHECK(EnhancedTriggerObject, 0x750);
GEODE_SIZE_CHECK(GJColorSetupLayer, 0x2e8);
GEODE_SIZE_CHECK(GJPFollowCommandLayer, 0x410);
GEODE_SIZE_CHECK(SetupCollisionStateTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(UploadActionPopup, 0x2a0);
GEODE_SIZE_CHECK(SetupCollisionTriggerPopup, 0x3d8);
GEODE_SIZE_CHECK(Slider, 0x1c8);
GEODE_SIZE_CHECK(MusicDelegateHandler, 0x148);
GEODE_SIZE_CHECK(SetupSFXEditPopup, 0x3b0);
GEODE_SIZE_CHECK(AudioEffectsLayer, 0x250);
GEODE_SIZE_CHECK(GameCell, 0x258);
GEODE_SIZE_CHECK(GJSpiderSprite, 0x328);
GEODE_SIZE_CHECK(RingObject, 0x748);
GEODE_SIZE_CHECK(LevelSettingsLayer, 0x370);
GEODE_SIZE_CHECK(EventLinkTrigger, 0x760);
GEODE_SIZE_CHECK(ObjectManager, 0x150);
GEODE_SIZE_CHECK(CustomSongLayer, 0x2b0);
GEODE_SIZE_CHECK(SetupAnimationPopup, 0x3c0);
GEODE_SIZE_CHECK(BoomScrollLayer, 0x270);
GEODE_SIZE_CHECK(CCScrollLayerExt, 0x1f8);
GEODE_SIZE_CHECK(GJSpecialColorSelect, 0x290);
GEODE_SIZE_CHECK(LocalLevelManager, 0x1b8);
GEODE_SIZE_CHECK(GJUserMessage, 0x1d8);
GEODE_SIZE_CHECK(SetupRotatePopup, 0x3a8);
GEODE_SIZE_CHECK(InfoLayer, 0x338);
GEODE_SIZE_CHECK(MultilineBitmapFont, 0x748);
GEODE_SIZE_CHECK(SetIDPopup, 0x2a8);
GEODE_SIZE_CHECK(SetupSmartBlockLayer, 0x2a8);
GEODE_SIZE_CHECK(RateDemonLayer, 0x2c8);
GEODE_SIZE_CHECK(SetupPlayerControlPopup, 0x3a8);
GEODE_SIZE_CHECK(SongInfoObject, 0x308);
GEODE_SIZE_CHECK(ColorSelectLiveOverlay, 0x340);
GEODE_SIZE_CHECK(SpawnTriggerGameObject, 0x790);
GEODE_SIZE_CHECK(SetupTimerControlTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(cocos2d::CCSet, 0x40);
GEODE_SIZE_CHECK(SetTargetIDLayer, 0x3b8);
GEODE_SIZE_CHECK(SetupCameraRotatePopup2, 0x3a8);
GEODE_SIZE_CHECK(VideoOptionsLayer, 0x2d8);
GEODE_SIZE_CHECK(LevelEditorLayer, 0x3b60);
GEODE_SIZE_CHECK(ObjectControlGameObject, 0x740);
GEODE_SIZE_CHECK(HSVWidgetPopup, 0x288);
GEODE_SIZE_CHECK(OptionsScrollLayer, 0x298);
GEODE_SIZE_CHECK(InfoAlertButton, 0x250);
GEODE_SIZE_CHECK(SelectSettingLayer, 0x290);
GEODE_SIZE_CHECK(CCSpritePlus, 0x270);
GEODE_SIZE_CHECK(ObjectToolbox, 0x150);
GEODE_SIZE_CHECK(ForceBlockGameObject, 0x758);
GEODE_SIZE_CHECK(FindObjectPopup, 0x2b0);
GEODE_SIZE_CHECK(SetupEventLinkPopup, 0x3a8);
GEODE_SIZE_CHECK(SetLevelOrderPopup, 0x2b0);
GEODE_SIZE_CHECK(OBB2D, 0x1b8);
GEODE_SIZE_CHECK(CommunityCreditNode, 0x170);
GEODE_SIZE_CHECK(SearchButton, 0x268);
GEODE_SIZE_CHECK(SetupSequenceTriggerPopup, 0x3c8);
GEODE_SIZE_CHECK(GJLocalScore, 0x48);
GEODE_SIZE_CHECK(StartPosObject, 0x748);
GEODE_SIZE_CHECK(ExtendedLayer, 0x1a0);
GEODE_SIZE_CHECK(BrowseSmartKeyLayer, 0x2d0);
GEODE_SIZE_CHECK(CreateGuidelinesLayer, 0x2e0);
GEODE_SIZE_CHECK(PointNode, 0x40);
GEODE_SIZE_CHECK(SFXBrowser, 0x330);
GEODE_SIZE_CHECK(GooglePlayManager, 0x150);
GEODE_SIZE_CHECK(GJPathsLayer, 0x290);
GEODE_SIZE_CHECK(MusicArtistObject, 0xa0);
GEODE_SIZE_CHECK(MusicBrowser, 0x338);
GEODE_SIZE_CHECK(CustomizeObjectSettingsPopup, 0x3b8);
GEODE_SIZE_CHECK(ShardsPage, 0x2a0);
GEODE_SIZE_CHECK(CurrencyRewardLayer, 0x280);
GEODE_SIZE_CHECK(SetupAreaAnimTriggerPopup, 0x3e0);
GEODE_SIZE_CHECK(SpawnParticleGameObject, 0x768);
GEODE_SIZE_CHECK(SetGroupIDLayer, 0x318);
GEODE_SIZE_CHECK(cocos2d::CCLightning, 0x198);
GEODE_SIZE_CHECK(TextGameObject, 0x578);
GEODE_SIZE_CHECK(RateStarsLayer, 0x2d8);
GEODE_SIZE_CHECK(SetupStopTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(ColorActionSprite, 0x160);
GEODE_SIZE_CHECK(GJBaseGameLayer, 0x37a0);
GEODE_SIZE_CHECK(ListCell, 0x238);
GEODE_SIZE_CHECK(SmartTemplateCell, 0x238);
GEODE_SIZE_CHECK(PlayerObject, 0xc48);
GEODE_SIZE_CHECK(GJMoreGamesLayer, 0x268);
GEODE_SIZE_CHECK(NumberInputLayer, 0x2b8);
GEODE_SIZE_CHECK(GJSmartPrefab, 0x80);
GEODE_SIZE_CHECK(GauntletLayer, 0x1e0);
GEODE_SIZE_CHECK(SetupGravityTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(AdvancedFollowEditObject, 0x850);
GEODE_SIZE_CHECK(SetupBGSpeedTrigger, 0x3a8);
GEODE_SIZE_CHECK(MultiTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(SongCell, 0x238);
GEODE_SIZE_CHECK(TransformTriggerGameObject, 0x758);
GEODE_SIZE_CHECK(UIOptionsLayer, 0x3e0);
GEODE_SIZE_CHECK(AnimatedShopKeeper, 0x300);
GEODE_SIZE_CHECK(SpriteAnimationManager, 0x1d8);
GEODE_SIZE_CHECK(SetItemIDLayer, 0x3a8);
GEODE_SIZE_CHECK(SongsLayer, 0x260);
GEODE_SIZE_CHECK(MapPackCell, 0x258);
GEODE_SIZE_CHECK(LevelSearchLayer, 0x1f0);
GEODE_SIZE_CHECK(HardStreak, 0x1c0);
GEODE_SIZE_CHECK(CustomListView, 0x1d8);
GEODE_SIZE_CHECK(DialogLayer, 0x288);
GEODE_SIZE_CHECK(AnimatedGameObject, 0x610);
GEODE_SIZE_CHECK(CCContentLayer, 0x220);
GEODE_SIZE_CHECK(SetupSmartTemplateLayer, 0x2a0);
GEODE_SIZE_CHECK(CurrencySprite, 0x2a8);
GEODE_SIZE_CHECK(CustomSFXWidget, 0x1d0);
GEODE_SIZE_CHECK(EditorUI, 0x5a8);
GEODE_SIZE_CHECK(ParentalOptionsLayer, 0x2a8);
GEODE_SIZE_CHECK(SetTextPopup, 0x2b8);
GEODE_SIZE_CHECK(SetupSpawnPopup, 0x3d8);
GEODE_SIZE_CHECK(GJScoreCell, 0x240);
GEODE_SIZE_CHECK(SetupAudioTriggerPopup, 0x3b0);
GEODE_SIZE_CHECK(GhostTrailEffect, 0x198);
GEODE_SIZE_CHECK(SetupZoomTriggerPopup, 0x3a8);
GEODE_SIZE_CHECK(CCCircleWave, 0x178);
GEODE_SIZE_CHECK(ParticleGameObject, 0x720);
GEODE_SIZE_CHECK(DialogObject, 0x88);
GEODE_SIZE_CHECK(TableView, 0x288);
GEODE_SIZE_CHECK(GJListLayer, 0x228);
GEODE_SIZE_CHECK(RetryLevelLayer, 0x278);
GEODE_SIZE_CHECK(SetupCoinLayer, 0x3a8);
GEODE_SIZE_CHECK(StatsObject, 0x48);
GEODE_SIZE_CHECK(AccountLoginLayer, 0x2f8);
GEODE_SIZE_CHECK(CCMoveCNode, 0xf0);
GEODE_SIZE_CHECK(KeybindingsLayer, 0x2a8);
GEODE_SIZE_CHECK(GameStatsManager, 0x3e0);
GEODE_SIZE_CHECK(SetupObjectOptionsPopup, 0x2b8);
GEODE_SIZE_CHECK(GJGameLevel, 0x5c8);
GEODE_SIZE_CHECK(SetupAdvFollowRetargetPopup, 0x3a8);
GEODE_SIZE_CHECK(DrawGridLayer, 0x280);
GEODE_SIZE_CHECK(GJPathPage, 0x2a0);
GEODE_SIZE_CHECK(SelectFontLayer, 0x290);
GEODE_SIZE_CHECK(RotateGameplayGameObject, 0x760);
GEODE_SIZE_CHECK(ItemInfoPopup, 0x288);
GEODE_SIZE_CHECK(SelectEventLayer, 0x3e0);
GEODE_SIZE_CHECK(ChallengeNode, 0x168);
GEODE_SIZE_CHECK(ShaderLayer, 0x668);
GEODE_SIZE_CHECK(GJMessagePopup, 0x2c8);
GEODE_SIZE_CHECK(CCAnimatedSprite, 0x2e8);
GEODE_SIZE_CHECK(SelectArtLayer, 0x2a0);
GEODE_SIZE_CHECK(GJRewardItem, 0x58);
GEODE_SIZE_CHECK(FMODAudioEngine, 0x888);
GEODE_SIZE_CHECK(GJRewardObject, 0x48);
GEODE_SIZE_CHECK(AccountHelpLayer, 0x298);
GEODE_SIZE_CHECK(SFXTriggerGameObject, 0x7e8);
GEODE_SIZE_CHECK(GravityEffectSprite, 0x258);
GEODE_SIZE_CHECK(GameOptionsTrigger, 0x778);
GEODE_SIZE_CHECK(DemonInfoPopup, 0x278);
GEODE_SIZE_CHECK(GJUnlockableItem, 0x38);
GEODE_SIZE_CHECK(SetupOpacityPopup, 0x3e0);
GEODE_SIZE_CHECK(PauseLayer, 0x238);
GEODE_SIZE_CHECK(DailyLevelNode, 0x178);
GEODE_SIZE_CHECK(GJShopLayer, 0x218);
