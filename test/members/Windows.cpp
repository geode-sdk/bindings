...
GEODE_MEMBER_CHECK(PlayerObject, m_robotSprite, 0x6e8);
GEODE_MEMBER_CHECK(PlayerObject, m_landParticles1, 0x720);
GEODE_MEMBER_CHECK(PlayerObject, m_hasCustomGlowColor, 0x78c);
GEODE_MEMBER_CHECK(PlayerObject, m_isDart, 0x7c4);
GEODE_MEMBER_CHECK(PlayerObject, m_lastGroundedPos, 0x834);
GEODE_MEMBER_CHECK(PlayerObject, m_touchingRings, 0x83c);
GEODE_MEMBER_CHECK(PlayerObject, m_lastActivatedPortal, 0x860);
GEODE_MEMBER_CHECK(PlayerObject, m_position, 0x86c);
GEODE_MEMBER_CHECK(PlayerObject, m_unk880, 0x89c);
GEODE_MEMBER_CHECK(PlayerObject, m_platformerXVelocity, 0x8c8);
GEODE_MEMBER_CHECK(PlayerObject, m_isPlatformer, 0x940);
GEODE_MEMBER_CHECK(PlayerObject, m_actionManager, 0x9c4);
