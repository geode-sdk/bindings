...
class BoomScrollLayer : cocos2d::CCLayer {
    ...
    int getTotalPages() = imac 0x391da0 {
...
class ButtonSprite : cocos2d::CCSprite {
    ...
    static ButtonSprite* create(char const* caption, int width, int p2, float scale, bool absolute, char const* font, char const* bg, float height) = win 0x3ee40, imac 0x92bd0;
