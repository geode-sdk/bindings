...
class cocos2d::CCEGLViewProtocol {
    ...
    virtual cocos2d::CCSize getVisibleSize() const = imac 0x4f9040;
    virtual cocos2d::CCPoint getVisibleOrigin() const = imac 0x4f9090;
    virtual void setDesignResolutionSize(float, float, ResolutionPolicy) = imac 0x4f8ea0;
    ...
    virtual cocos2d::CCRect getScissorRect() = imac 0x4f91b0;
    virtual void setViewName(char const*) = imac 0x4f9250;
...
class cocos2d::CCMotionStreak {
    static cocos2d::CCMotionStreak* create(float, float, float, cocos2d::_ccColor3B const&, cocos2d::CCTexture2D*) = imac 0x55e760;
    static cocos2d::CCMotionStreak* create(float, float, float, cocos2d::_ccColor3B const&, char const*) = imac 0x55e760;

    bool initWithFade(float, float, float, cocos2d::_ccColor3B const&, cocos2d::CCTexture2D*) = imac 0x55e8b0;
    bool initWithFade(float, float, float, cocos2d::_ccColor3B const&, char const*) = imac 0x55e8b0;
    ...
    void reset() = imac 0x55f510;
    void resumeStroke();
    void stopStroke();
    void tintWithColor(cocos2d::_ccColor3B);
    void updateFade(float) = imac 0x55ee90;

    ~CCMotionStreak();

    virtual void update(float);
    virtual void setPosition(cocos2d::CCPoint const&) = imac 0x55ec30;
    virtual void draw() = imac 0x55f530;
...
class cocos2d::CCMoveBy {
    static cocos2d::CCMoveBy* create(float, cocos2d::CCPoint const&) = imac 0x3a44c0;
...
class cocos2d::CCMoveTo {
    static cocos2d::CCMoveTo* create(float, cocos2d::CCPoint const&) = imac 0x3a48d0;
...
class cocos2d::CCTintTo {
    static cocos2d::CCTintTo* create(float, unsigned char, unsigned char, unsigned char) = imac 0x3a77e0;
...
class cocos2d::CCAction {
    ...
    virtual cocos2d::CCObject* copyWithZone(cocos2d::CCZone*) = imac 0x5dbeb0;
    virtual void update(float);
    //virtual void setTag(int) = m1 0x1b6e5c, imac 0x205680;
    virtual bool isDone();
    virtual void startWithTarget(cocos2d::CCNode*) = imac 0x5dbf70;
    virtual void stop();
...
class cocos2d::CCScene {
    static cocos2d::CCScene* create() = imac 0x27e730;

    int getHighestChildZ() = imac 0x27e7f0;
...
class cocos2d::CCSet {
    ...
    CCSet();
    ~CCSet() = imac 0x79d460;
    void addObject(cocos2d::CCObject*) = imac 0x79d710;
    cocos2d::CCObject* anyObject() = imac 0x79d8e0;
    cocos2d::CCSetIterator begin() = imac 0x79d8c0;
    bool containsObject(cocos2d::CCObject*) = imac 0x79d870;
    cocos2d::CCSet* copy();
    int count();
    cocos2d::CCSetIterator end() = imac 0x79d8d0;
    cocos2d::CCSet* mutableCopy();
    void removeAllObjects();
    void removeObject(cocos2d::CCObject*) = imac 0x79d7c0;
...
class cocos2d::CCShaderCache {
    ...
    static cocos2d::CCShaderCache* sharedShaderCache() = imac 0x1efc10;
...
class cocos2d::CCParticleSystem {
    static cocos2d::CCParticleSystem* create(char const*) = imac 0x7b0890;
    static cocos2d::CCParticleSystem* createWithTotalParticles(unsigned int);

    void initParticle(cocos2d::sCCParticle*) = imac 0x7b2a80;
    bool initWithDictionary(cocos2d::CCDictionary*, char const*, bool);
    bool initWithDictionary(cocos2d::CCDictionary*, bool) = imac 0x7b2600;
    ...
    bool isFull();
    void loadDefaults();
    void loadScaledDefaults(float) = imac 0x7b54f0;
    void resetSystem() = imac 0x7b3b50;
    void resumeSystem();
    void saveDefaults();
    void stopSystem() = imac 0x7b3b10;
    void toggleUniformColorMode(bool);
    void updateVisible();

    virtual void update(float) = imac 0x7b3d00;
    virtual bool init();
...
class cocos2d::CCParticleSystemQuad {
    static cocos2d::CCParticleSystemQuad* create(char const*, bool) = imac 0x5ea510;
    static cocos2d::CCParticleSystemQuad* create();
    static cocos2d::CCParticleSystemQuad* createWithTotalParticles(unsigned int, bool);

    void initIndices();
    void initTexCoordsWithRect(cocos2d::CCRect const&) = imac 0x5ea6e0;
    ...
    ~CCParticleSystemQuad() = imac 0x5ea430;
    bool allocMemory() = imac 0x5e9de0;
    void listenBackToForeground(cocos2d::CCObject*);
    [[missing(mac, ios)]]
    void setupVBO();
    [[missing(win, android)]]
    void setupVBOandVAO() = imac 0x5ea1c0;
    void updateTexCoords();

    virtual void draw() = imac 0x5eae80;
    virtual void setBatchNode(cocos2d::CCParticleBatchNode*) = imac 0x5eb460;
    virtual void setTotalParticles(unsigned int) = imac 0x5eaf40;
    virtual bool initWithTotalParticles(unsigned int, bool);
    virtual void updateQuadWithParticle(cocos2d::sCCParticle*, cocos2d::CCPoint const&) = imac 0x5eaae0;
    virtual void postStep() = imac 0x5eae30;

    virtual void setTexture(cocos2d::CCTexture2D*) = imac 0x5ea930;
}

[[link(win, android)]]
class cocos2d::CCProgressTimer {
    static cocos2d::CCProgressTimer* create(cocos2d::CCSprite*) = imac 0x5ebaf0;
    ...
    void setPercentage(float) = imac 0x5ebd70;
    void setReverseDirection(bool);
    void setReverseProgress(bool);
    void setSprite(cocos2d::CCSprite*) = imac 0x5ebdf0;
    void setType(cocos2d::CCProgressTimerType) = imac 0x5ec000;
...
class cocos2d::CCFadeTo {
    static cocos2d::CCFadeTo* create(float, unsigned char) = imac 0x3a7500;
...
class cocos2d::CCFileUtils {
    ...
    virtual unsigned char* getFileData(char const*, char const*, unsigned long*) = imac 0x426400;
    ...
    virtual gd::string getWritablePath2() = imac 0x4291b0;
    virtual bool init();
    virtual bool isAbsolutePath(gd::string const&) = imac 0x4290f0;
...
class cocos2d::CCGLProgram {
    bool initWithVertexShaderByteArray(char const*, char const*) = imac 0x4172a0;
    ...
    void setUniformsForBuiltins() = imac 0x418640;

    // CCGLProgram(cocos2d::CCGLProgram const&);
    ~CCGLProgram();
    CCGLProgram();
    void addAttribute(char const*, unsigned int) = imac 0x417520;
    ...
    void reset() = imac 0x418970;
    bool updateUniformLocation(int, void*, unsigned int);
    void updateUniforms() = imac 0x417540;
    void use();
...
class cocos2d::CCNode {
    ...
    cocos2d::CCRect boundingBox() = imac 0x2605d0;
    void childrenAlloc();
    ...
    cocos2d::CCAction* runAction(cocos2d::CCAction*) = imac 0x261880;
    void schedule(cocos2d::SEL_SCHEDULE) = imac 0x261ab0;
    void schedule(cocos2d::SEL_SCHEDULE, float) = imac 0x261b10;
    void schedule(cocos2d::SEL_SCHEDULE, float, unsigned int, float) = imac 0x261ae0;
    void scheduleOnce(cocos2d::SEL_SCHEDULE, float) = imac 0x261b40;
    void scheduleUpdate() = imac 0x261990;
    void scheduleUpdateWithPriority(int) = imac 0x2619c0;
    void scheduleUpdateWithPriorityLua(int, int) = imac 0x2619f0;
    ...
    void unschedule(cocos2d::SEL_SCHEDULE) = imac 0x261b70;
    void unscheduleAllSelectors();
    void unscheduleUpdate() = imac 0x261a60;
    void updateChildIndexes();

    virtual void update(float) = imac 0x261b90;
    virtual bool init();
    virtual void setZOrder(int) = imac 0x25fee0;
    ...
    virtual void setScale(float) = imac 0x260000;
    virtual float getScale();
    virtual void setScale(float, float) = imac 0x260020;
    virtual void setPosition(cocos2d::CCPoint const&) = imac 0x2600b0;
    virtual cocos2d::CCPoint const& getPosition();
    virtual void setPosition(float, float);
    virtual void getPosition(float*, float*) = imac 0x2600d0;
    ...
    virtual cocos2d::CCSize getScaledContentSize() = imac 0x2603b0;
    virtual void setVisible(bool);
    virtual bool isVisible();
    virtual void setRotation(float) = imac 0x25ff50;
    ...
    virtual void ignoreAnchorPointForPosition(bool) = imac 0x2604a0;
    virtual bool isIgnoreAnchorPointForPosition();
    virtual void addChild(cocos2d::CCNode*) = imac 0x260990;
    virtual void addChild(cocos2d::CCNode*, int) = imac 0x260970;
    virtual void addChild(cocos2d::CCNode*, int, int) = imac 0x260840;
    virtual cocos2d::CCNode* getChildByTag(int);
    virtual cocos2d::CCArray* getChildren() = imac 0x2601d0;
    virtual unsigned int getChildrenCount() const;
    virtual void setParent(cocos2d::CCNode*);
    virtual cocos2d::CCNode* getParent();
    virtual void removeFromParent();
    virtual void removeFromParentAndCleanup(bool) = imac 0x2609d0;
    virtual void removeMeAndCleanup();
    virtual void removeChild(cocos2d::CCNode*);
    virtual void removeChild(cocos2d::CCNode*, bool) = imac 0x260a40;
    virtual void removeChildByTag(int);
    virtual void removeChildByTag(int, bool) = imac 0x260bb0;
    virtual void removeAllChildren();
    virtual void removeAllChildrenWithCleanup(bool);
    virtual void reorderChild(cocos2d::CCNode*, int) = imac 0x260d20;
    virtual void sortAllChildren() = imac 0x260e60;
    ...
    virtual cocos2d::CCCamera* getCamera() = imac 0x260240;
    virtual bool isRunning();
    virtual void registerScriptHandler(int);
    virtual void unregisterScriptHandler();
    virtual void onEnter() = imac 0x261470;
    virtual void onEnterTransitionDidFinish() = imac 0x261590;
    virtual void onExit() = imac 0x261690;
    virtual void onExitTransitionDidStart();
    virtual void cleanup() = imac 0x2606a0;
    virtual void draw();
    virtual void visit();
    ...
    virtual void updateTransform() = imac 0x2627d0;
    virtual cocos2d::CCAffineTransform const nodeToParentTransform() = imac 0x261c00;
    virtual cocos2d::CCAffineTransform const nodeToParentTransformFast() = imac 0x261f10;
    virtual cocos2d::CCAffineTransform const parentToNodeTransform() = imac 0x262360;
    virtual cocos2d::CCAffineTransform nodeToWorldTransform();
    virtual cocos2d::CCAffineTransform nodeToWorldTransformFast();
    virtual cocos2d::CCAffineTransform worldToNodeTransform() = imac 0x262500;
...
class cocos2d::CCScheduler {
    ...
    void pauseTarget(cocos2d::CCObject*) = imac 0x42eca0;
    ...
    void scheduleSelector(cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, unsigned int, float, bool) = imac 0x42d690;
    void scheduleSelector(cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, bool) = imac 0x42d670;
    void scheduleUpdateForTarget(cocos2d::CCObject*, int, bool) = imac 0x42e2a0;
    void unscheduleAll();
    void unscheduleAllForTarget(cocos2d::CCObject*) = imac 0x42e860;
    void unscheduleAllWithMinPriority(int);
    void unscheduleScriptEntry(unsigned int);
    void unscheduleSelector(cocos2d::SEL_SCHEDULE, cocos2d::CCObject*) = imac 0x42d1a0;
    void unscheduleUpdateForTarget(cocos2d::CCObject const*);

    virtual void update(float) = imac 0x42f2e0;
}

[[link(win, android)]]
class cocos2d::CCLayer {
    static cocos2d::CCLayer* create() = imac 0x49c9e0;
    ...
    virtual void onEnterTransitionDidFinish() = imac 0x49d410;
    virtual void onExit();
    virtual void registerWithTouchDispatcher();
    virtual void registerScriptTouchHandler(int, bool, int, bool) = imac 0x49cb90;
    virtual void unregisterScriptTouchHandler();
    virtual bool isTouchEnabled();
    virtual void setTouchEnabled(bool) = imac 0x49ccb0;
    virtual void setTouchMode(cocos2d::ccTouchesMode);
    virtual int getTouchMode();
    virtual void setTouchPriority(int);
    virtual int getTouchPriority();
    virtual bool isAccelerometerEnabled();
    virtual void setAccelerometerEnabled(bool) = imac 0x49cdf0;
    virtual void setAccelerometerInterval(double) = imac 0x49ce30;
    virtual bool isKeypadEnabled();
    virtual void setKeypadEnabled(bool) = imac 0x49cf40;
    ...
    virtual void ccTouchesBegan(cocos2d::CCSet*, cocos2d::CCEvent*) = imac 0x49d660;
    ...
    virtual void didAccelerate(cocos2d::CCAcceleration*) = imac 0x49ce60;

    virtual void keyBackClicked() = imac 0x49d0e0;
    virtual void keyMenuClicked() = imac 0x49d180;
...
class cocos2d::CCLayerGradient {
    ...
    virtual bool init() = imac 0x49fc60;

    virtual void updateColor() = imac 0x49fda0;
    virtual bool initWithColor(cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&) = imac 0x49fc90;
    virtual bool initWithColor(cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&, cocos2d::CCPoint const&) = imac 0x49fcf0;
    ...
    virtual void setEndColor(cocos2d::_ccColor3B const&) = imac 0x49ffc0;
    ...
    virtual void setVector(cocos2d::CCPoint const&) = imac 0x4a0060;
...
class cocos2d::CCObject {
    ...
    bool isSingleReference() const = imac 0x4772b0;
    void release() = imac 0x477250;
    void retain() = imac 0x477270;
    unsigned int retainCount() const;

    virtual int getTag() const;
    virtual bool isEqual(cocos2d::CCObject const*) = imac 0x4772d0;
    virtual void acceptVisitor(cocos2d::CCDataVisitor&);
...
class cocos2d::CCLayerColor {
    static cocos2d::CCLayerColor* create(cocos2d::_ccColor4B const&) = imac 0x49f020;
    ...
    virtual bool init();
    virtual void setContentSize(cocos2d::CCSize const&) = imac 0x49f3e0;
    virtual void draw();
    virtual bool initWithColor(cocos2d::_ccColor4B const&, float, float) = imac 0x49f240;
    virtual bool initWithColor(cocos2d::_ccColor4B const&);
    virtual void updateColor() = imac 0x49f4d0;

    virtual void setColor(cocos2d::_ccColor3B const&) = imac 0x49f5f0;
    virtual void setOpacity(unsigned char) = imac 0x49f770;
...
class cocos2d::CCMouseDispatcher {
    ...
    bool dispatchScrollMSG(float, float) = imac 0x559810;
...
class cocos2d::CCTexture2D {
    static void PVRImagesHavePremultipliedAlpha(bool) = imac 0x465c40;
    ...
    bool initWithData(void const*, cocos2d::CCTexture2DPixelFormat, unsigned int, unsigned int, cocos2d::CCSize const&) = imac 0x464a90;
    bool initWithETCFile(char const*) = imac 0x465b70;
    bool initWithImage(cocos2d::CCImage*);
    bool initWithPVRFile(char const*) = imac 0x465a90;
    bool initWithString(char const*, char const*, float) = imac 0x4656e0;
    bool initWithString(char const*, char const*, float, cocos2d::CCSize const&, cocos2d::CCTextAlignment, cocos2d::CCVerticalTextAlignment) = imac 0x465740;
    ...
    void setTexParameters(cocos2d::_ccTexParams*) = imac 0x465ca0;

    // CCTexture2D(cocos2d::CCTexture2D const&);
    ~CCTexture2D();
    CCTexture2D();
    unsigned int bitsPerPixelForFormat(cocos2d::CCTexture2DPixelFormat) = imac 0x464d90;
    unsigned int bitsPerPixelForFormat() = imac 0x465e20;
    char const* description() = imac 0x464db0;
    void drawAtPoint(cocos2d::CCPoint const&);
    void drawInRect(cocos2d::CCRect const&);
    void generateMipmap() = imac 0x465c50;
    bool hasMipmaps();
    bool hasPremultipliedAlpha();
    void* keepData(void*, unsigned int);
    void releaseData(void*);
    void releaseGLTexture() = imac 0x464a30;
    char const* stringForFormat() = imac 0x465dd0;
...
class cocos2d::CCTextureCache {
    ...
    static cocos2d::CCTextureCache* sharedTextureCache() = imac 0x5d39b0;

    // CCTextureCache(cocos2d::CCTextureCache const&);
    // CCTextureCache();
    cocos2d::CCTexture2D* addETCImage(char const*);
    cocos2d::CCTexture2D* addImage(char const*, bool) = imac 0x5d4c40;
    void addImageAsync(char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, int, cocos2d::CCTexture2DPixelFormat) = imac 0x5d3e80;
    void addImageAsyncCallBack(float);
    cocos2d::CCTexture2D* addPVRImage(char const*);
    cocos2d::CCTexture2D* addUIImage(cocos2d::CCImage*, char const*) = imac 0x5d5a80;
    char const* description();
    ...
    void removeTextureForKey(char const*) = imac 0x5d6020;
    void removeUnusedTextures();
    cocos2d::CCDictionary* snapshotTextures();
    cocos2d::CCTexture2D* textureForKey(char const*) = imac 0x5d60a0;
}

[[link(win, android)]]
class cocos2d::CCTouch {
    cocos2d::CCPoint getLocationInView() const = imac 0x593b0;
...
class cocos2d::CCTouchDispatcher {
    ...
    // CCTouchDispatcher();
    void addPrioTargetedDelegate(cocos2d::CCTouchDelegate*, int, bool) = imac 0x4b7d00;
    void addStandardDelegate(cocos2d::CCTouchDelegate*, int);
    void addTargetedDelegate(cocos2d::CCTouchDelegate*, int, bool) = imac 0x4b7d20;
    ...
    void forceRemoveDelegate(cocos2d::CCTouchDelegate*) = imac 0x4b8090;
    void incrementForcePrio(int);
    bool isDispatchEvents();
    bool isUsingForcePrio() = imac 0x4b7cf0;
    ...
    void registerForcePrio(cocos2d::CCObject*, int) = imac 0x4b7c00;
    void removeAllDelegates();
    void removeDelegate(cocos2d::CCTouchDelegate*);
    void touches(cocos2d::CCSet*, cocos2d::CCEvent*, unsigned int) = imac 0x4b85a0;
    void unregisterForcePrio(cocos2d::CCObject*) = imac 0x4b7ca0;

    virtual void touchesBegan(cocos2d::CCSet*, cocos2d::CCEvent*) = imac 0x4b8bc0;
    virtual void touchesMoved(cocos2d::CCSet*, cocos2d::CCEvent*) = imac 0x4b8c00;
    virtual void touchesEnded(cocos2d::CCSet*, cocos2d::CCEvent*) = imac 0x4b8c40;
    virtual void touchesCancelled(cocos2d::CCSet*, cocos2d::CCEvent*) = imac 0x4b8c80;
}
...
class cocos2d::CCImage {
    ...
    bool initWithImageFile(char const*, cocos2d::CCImage::EImageFormat) = imac 0x475fe0;
    bool initWithImageFileThreadSafe(char const*, cocos2d::CCImage::EImageFormat) = imac 0x4767d0;
...
class cocos2d::CCIMEDelegate {
    ~CCIMEDelegate();
    virtual bool attachWithIME() = imac 0x4a80c0;
    virtual bool detachWithIME() = imac 0x4a82b0;
    virtual void deleteForward() {}
}

[[link(win, android)]]
class cocos2d::CCIMEDispatcher {
    static cocos2d::CCIMEDispatcher* sharedDispatcher() = imac 0x4a7e10;
    ...
    void dispatchInsertText(char const*, int, cocos2d::enumKeyCodes) = imac 0x4a8580;
    ...
    bool hasDelegate() = imac 0x4a8560;
...
class cocos2d::CCKeyboardDispatcher {
    ...
    bool dispatchKeyboardMSG(cocos2d::enumKeyCodes, bool, bool) = imac 0x1f10b0;
    void forceAddDelegate(cocos2d::CCKeyboardDelegate*);
    void forceRemoveDelegate(cocos2d::CCKeyboardDelegate*);
    char const* keyToString(cocos2d::enumKeyCodes) = imac 0x1f13a0;
    void removeDelegate(cocos2d::CCKeyboardDelegate*);
    void updateModifierKeys(bool, bool, bool, bool) = imac 0x1f1370;
}
...
class cocos2d::CCDirector {
    static cocos2d::CCDirector* sharedDirector() = imac 0x46e970;
    ...
    cocos2d::CCSize getWinSize() = imac 0x46fd90;
    ...
    void setDepthTest(bool) = imac 0x46f0b0;
    void setDisplayStats(bool);
    void setDontCallWillSwitch(bool);
    void setGLDefaultValues() = imac 0x46f040;
    ...
    void setViewport() = imac 0x4701d0;
    ...
    cocos2d::CCPoint convertToGL(cocos2d::CCPoint const&) = imac 0x4702c0;
    ...
    void pause();
    void popScene();
    bool popSceneWithTransition(float, cocos2d::PopTransition) = imac 0x470930;
    void popToRootScene();
    void popToSceneInStack(cocos2d::CCScene*);
    void popToSceneStackLevel(int);
    void purgeCachedData();
    void purgeDirector() = imac 0x470bf0;
    bool pushScene(cocos2d::CCScene*) = imac 0x4706a0;
    void removeStatsLabel() = imac 0x470e00;
    bool replaceScene(cocos2d::CCScene*) = imac 0x470750;
    void resetSmoothFixCounter();
    void reshapeProjection(cocos2d::CCSize const&);
    void resume() = imac 0x470d80;
    void runWithScene(cocos2d::CCScene*) = imac 0x470600;
    int sceneCount();
    void setupScreenScale(cocos2d::CCSize, cocos2d::CCSize, cocos2d::TextureQuality);
    void showFPSLabel();
    void showStats();
    void toggleShowFPS(bool, gd::string, cocos2d::CCPoint) = imac 0x46fc70;
    void updateContentScale(cocos2d::TextureQuality);
    void updateScreenScale(cocos2d::CCSize);
    void willSwitchToScene(cocos2d::CCScene*) = imac 0x4705b0;
...
class cocos2d::CCNodeRGBA {
    ...
    virtual bool init() = imac 0x2629a0;
...
class cocos2d::CCSequence {
    ...
    static cocos2d::CCSequence* createWithTwoActions(cocos2d::CCFiniteTimeAction*, cocos2d::CCFiniteTimeAction*) = imac 0x3a1910;
    static cocos2d::CCSequence* createWithVariableList(cocos2d::CCFiniteTimeAction*, va_list) = imac 0x3a1af0;

    bool initWithTwoActions(cocos2d::CCFiniteTimeAction*, cocos2d::CCFiniteTimeAction*) = imac 0x3a19e0;

    // CCSequence(cocos2d::CCSequence const&);
    // CCSequence();

    virtual cocos2d::CCObject* copyWithZone(cocos2d::CCZone*);
    virtual void update(float) = imac 0x3a22c0;
    virtual void startWithTarget(cocos2d::CCNode*);
    virtual void stop() = imac 0x3a2290;
    virtual cocos2d::CCActionInterval* reverse() = imac 0x3a2460;
}
...
class cocos2d::CCSprite {
    ...
    virtual bool init() = imac 0x276090;
    virtual void setVertexZ(float);
    virtual void setScaleX(float);
    virtual void setScaleY(float);
    virtual void setScale(float) = imac 0x277a80;
    virtual void setPosition(cocos2d::CCPoint const&) = imac 0x2776f0;
    virtual void setSkewX(float);
    virtual void setSkewY(float);
    virtual void setAnchorPoint(cocos2d::CCPoint const&);
    virtual void setVisible(bool);
    ...
    virtual void addChild(cocos2d::CCNode*, int, int) = imac 0x277250;
    virtual void removeChild(cocos2d::CCNode*, bool) = imac 0x277390;
    virtual void removeAllChildrenWithCleanup(bool);
    virtual void reorderChild(cocos2d::CCNode*, int) = imac 0x277310;
    virtual void sortAllChildren();
    virtual void draw();
    virtual void updateTransform() = imac 0x276c50;
    virtual bool initWithTexture(cocos2d::CCTexture2D*);
    virtual bool initWithTexture(cocos2d::CCTexture2D*, cocos2d::CCRect const&);
    virtual bool initWithTexture(cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool) = imac 0x2760b0;
    ...
    virtual void setBatchNode(cocos2d::CCSpriteBatchNode*) = imac 0x2789c0;
    virtual void refreshTextureRect() = imac 0x276600;
    virtual void setTextureRect(cocos2d::CCRect const&) = imac 0x276690;
    virtual void setTextureRect(cocos2d::CCRect const&, bool, cocos2d::CCSize const&) = imac 0x2766b0;
    virtual void setVertexRect(cocos2d::CCRect const&) = imac 0x2769f0;
    virtual void setDisplayFrame(cocos2d::CCSpriteFrame*) = imac 0x2786a0;
    virtual bool isFrameDisplayed(cocos2d::CCSpriteFrame*) = imac 0x278770;
    virtual cocos2d::CCSpriteFrame* displayFrame() = imac 0x278800;
    virtual void setDisplayFrameWithAnimationName(char const*, int);
    virtual void setTextureCoords(cocos2d::CCRect const&) = imac 0x276a10;
    virtual void updateBlendFunc();
    virtual void setReorderChildDirtyRecursively() = imac 0x277610;
    virtual void setDirtyRecursively(bool) = imac 0x277670;

    virtual void setOpacity(unsigned char) = imac 0x277e20;
    virtual void updateDisplayedOpacity(unsigned char);
    virtual void setColor(cocos2d::_ccColor3B const&) = imac 0x278070;
    virtual void updateDisplayedColor(cocos2d::_ccColor3B const&);
    virtual void setOpacityModifyRGB(bool);
    virtual bool isOpacityModifyRGB();

    virtual void setTexture(cocos2d::CCTexture2D*) = imac 0x278a90;
    virtual cocos2d::CCTexture2D* getTexture();
}
...
class cocos2d::CCLabelBMFont {
    ...
    static cocos2d::CCLabelBMFont* create(char const*, char const*) = imac 0x5bf250;
    static cocos2d::CCLabelBMFont* create(char const*, char const*, float);
    static cocos2d::CCLabelBMFont* create(char const*, char const*, float, cocos2d::CCTextAlignment) = imac 0x5bf1a0;
    static cocos2d::CCLabelBMFont* create(char const*, char const*, float, cocos2d::CCTextAlignment, cocos2d::CCPoint) = imac 0x5bf100;
    ...
    static cocos2d::CCLabelBMFont* createBatched(char const*, char const*, cocos2d::CCArray*, int) = imac 0x5bf5d0;
    static void purgeCachedData();

    bool initWithString(char const*, char const*, float, cocos2d::CCTextAlignment, cocos2d::CCPoint) = imac 0x5bf300;

    cocos2d::CCBMFontConfiguration* getConfiguration() const;
    int getExtraKerning() const;
    char const* getFntFile() = imac 0x5c26a0;
    ...
    void setFntFile(char const*) = imac 0x5c25c0;
    void setIsBatched(bool);
    void setTargetArray(cocos2d::CCArray*);
    void createFontChars() = imac 0x5bfa30;
    int kerningAmountForFirst(unsigned short, unsigned short);
    void limitLabelWidth(float, float, float) = imac 0x5c26e0;

    ~CCLabelBMFont();
    virtual bool init() = imac 0x5bf680;
    virtual void setScaleX(float);
    virtual void setScaleY(float);
    virtual void setScale(float);
    virtual void setAnchorPoint(cocos2d::CCPoint const&) = imac 0x5c0df0;
    virtual void setString(char const*);
    virtual void setString(char const*, bool) = imac 0x5c0380;
    virtual char const* getString();
    virtual void setCString(char const*);
    virtual void updateLabel();
    virtual void setAlignment(cocos2d::CCTextAlignment) = imac 0x5c2500;
    virtual void setWidth(float) = imac 0x5c2520;
    ...
    virtual unsigned char getOpacity();
    virtual void setOpacity(unsigned char);
    virtual void setOpacityModifyRGB(bool) = imac 0x5c0950;
    virtual bool isOpacityModifyRGB();
    virtual bool isCascadeColorEnabled();
    virtual void setCascadeColorEnabled(bool);
    virtual void updateDisplayedColor(cocos2d::_ccColor3B const&) = imac 0x5c0bd0;
    virtual bool isCascadeOpacityEnabled();
    virtual void setCascadeOpacityEnabled(bool);
    virtual void updateDisplayedOpacity(unsigned char) = imac 0x5c0ad0;
...
class cocos2d::CCActionManager {
    ...
    void pauseTarget(cocos2d::CCObject*) = imac 0x221410;
    void resumeTarget(cocos2d::CCObject*) = imac 0x2214f0;
}

[[link(win, android)]]
class cocos2d::CCAnimate {
    static cocos2d::CCAnimate* create(cocos2d::CCAnimation*) = imac 0x3a8510;
...
class cocos2d::CCAnimation {
    ...
    static cocos2d::CCAnimation* create(cocos2d::CCArray*, float, unsigned int) = imac 0x284440;
    static cocos2d::CCAnimation* create();
    static cocos2d::CCAnimation* createWithSpriteFrames(cocos2d::CCArray*, float) = imac 0x284240;
...
class cocos2d::CCApplication {
    ...
    virtual int run();
    virtual void openURL(char const*) = imac 0x315600;
}
...
class cocos2d::CCDictionary {
    ...
    void setObject(cocos2d::CCObject*, gd::string const&) = imac 0x2f9e30;
    void setObject(cocos2d::CCObject*, intptr_t) = imac 0x2f9e30;
    ...
    cocos2d::CCArray* allKeys() = imac 0x2f9580;
    cocos2d::CCArray* allKeysForObject(cocos2d::CCObject*);
    char const* charForKey(gd::string const&);
    unsigned int count() = imac 0x2f9560;
    cocos2d::CCObject* objectForKey(gd::string const&) = imac 0x2f98f0;
    cocos2d::CCObject* objectForKey(intptr_t) = imac 0x2f9c80;
    cocos2d::CCObject* randomObject();
    void removeAllObjects();
    void removeObjectForElememt(cocos2d::CCDictElement*) = imac 0x2fb150;
    void removeObjectForKey(gd::string const&) = imac 0x2fad50;
    void removeObjectForKey(intptr_t) = imac 0x2fb2a0;
    void removeObjectsForKeys(cocos2d::CCArray*);
    cocos2d::CCString const* valueForKey(gd::string const&) = imac 0x2f9870;
    cocos2d::CCString const* valueForKey(intptr_t) = imac 0x2f9db0;
...
class cocos2d::CCRenderTexture {
    static cocos2d::CCRenderTexture* create(int, int) = imac 0x5dd320;
    static cocos2d::CCRenderTexture* create(int, int, cocos2d::CCTexture2DPixelFormat) = imac 0x5dcde0;
    static cocos2d::CCRenderTexture* create(int, int, cocos2d::CCTexture2DPixelFormat, unsigned int) = imac 0x5dceb0;
    ...
    CCRenderTexture();
    void begin() = imac 0x5dd400;
    void beginWithClear(float, float, float, float, float, int, unsigned int) = imac 0x5dd6d0;
    void beginWithClear(float, float, float, float) = imac 0x5dd630;
    void beginWithClear(float, float, float, float, float) = imac 0x5dd870;
    void beginWithClear(float, float, float, float, float, int) = imac 0x5dd950;
    ...
    virtual void draw() = imac 0x5ddc10;
    virtual void visit();
...
class cocos2d::CCRepeat {
    static cocos2d::CCRepeat* create(cocos2d::CCFiniteTimeAction*, unsigned int) = imac 0x3a2550;
...
class cocos2d::CCTransitionFade {
    ...
    static cocos2d::CCTransitionFade* create(float, cocos2d::CCScene*, cocos2d::_ccColor3B const&) = imac 0xd88f0;
    ...
    virtual void onEnter();
    virtual void onExit();
    virtual bool initWithDuration(float, cocos2d::CCScene*) = imac 0xd8a60;
    virtual bool initWithDuration(float, cocos2d::CCScene*, cocos2d::_ccColor3B const&) = imac 0xd8a10;
}
...
class cocos2d::CCTransitionScene {
    ...
    virtual void draw();
    virtual bool initWithDuration(float, cocos2d::CCScene*) = imac 0xd4820;
    virtual void sceneOrder();
}

[[link(win, android)]]
class cocos2d::CCBlink {
    static cocos2d::CCBlink* create(float, unsigned int) = imac 0x3a6c40;
...
class cocos2d::CCCallFunc {
    static cocos2d::CCCallFunc* create(cocos2d::CCObject*, cocos2d::SEL_CallFunc) = imac 0x7966b0;
}

[[link(win, android)]]
class cocos2d::CCCallFuncN {
    static cocos2d::CCCallFuncN* create(cocos2d::CCObject*, cocos2d::SEL_CallFuncN) = imac 0x796ad0;
}

[[link(win, android)]]
class cocos2d::CCCallFuncO {
    static cocos2d::CCCallFuncO* create(cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCObject*) = imac 0x7971b0;
...
class cocos2d::CCDrawNode {
    ...
    void setBlendFunc(cocos2d::_ccBlendFunc const&) = imac 0x5fa5e0;

    // CCDrawNode(cocos2d::CCDrawNode const&);
    CCDrawNode();
    ~CCDrawNode();
    void clear() = imac 0x5fa5b0;
    void drawCircle(cocos2d::CCPoint const&, float, cocos2d::_ccColor4F const&, float, cocos2d::_ccColor4F const&, unsigned int) = imac 0x5fa400;
    ...
    void ensureCapacity(unsigned int) = imac 0x5f8930;
    void listenBackToForeground(cocos2d::CCObject*) = imac 0x5fa5f0;
    void render() = imac 0x5f8ae0;

    virtual bool init() = imac 0x5f8980;
    virtual void draw();
}
...
class cocos2d::CCSpriteBatchNode {
    ...
    bool initWithTexture(cocos2d::CCTexture2D*, unsigned int) = imac 0x165310;

    CCSpriteBatchNode();
    ~CCSpriteBatchNode();

    virtual bool init() = imac 0x165590;
    virtual void addChild(cocos2d::CCNode*);
    virtual void addChild(cocos2d::CCNode*, int);
    virtual void addChild(cocos2d::CCNode*, int, int) = imac 0x165800;
    virtual void removeChild(cocos2d::CCNode*, bool) = imac 0x165ae0;
    virtual void removeAllChildrenWithCleanup(bool);
    virtual void reorderChild(cocos2d::CCNode*, int) = imac 0x165a80;
    virtual void sortAllChildren() = imac 0x165e70;
    virtual void draw() = imac 0x166650;
    virtual void visit() = imac 0x165760;
...
class cocos2d::CCSpriteFrame {
    ...
    bool initWithTexture(cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool, cocos2d::CCPoint const&, cocos2d::CCSize const&) = imac 0x343ab0;
    ...
    bool initWithTextureFilename(char const*, cocos2d::CCRect const&, bool, cocos2d::CCPoint const&, cocos2d::CCSize const&) = imac 0x343de0;
    ...
    cocos2d::CCTexture2D* getTexture() = imac 0x3445d0;

    void setFrameName(gd::string);
    void setOffset(cocos2d::CCPoint const&) = imac 0x3444a0;
    void setOffsetInPixels(cocos2d::CCPoint const&) = imac 0x344540;
    void setOriginalSize(cocos2d::CCSize const&);
    void setOriginalSizeInPixels(cocos2d::CCSize const&);
    void setRect(cocos2d::CCRect const&) = imac 0x3442d0;
    void setRectInPixels(cocos2d::CCRect const&) = imac 0x3443b0;
    void setRotated(bool);
    void setTexture(cocos2d::CCTexture2D*) = imac 0x344290;
    ...
    virtual cocos2d::CCObject* copyWithZone(cocos2d::CCZone*) = imac 0x344130;
}

[[link(win, android)]]
class cocos2d::CCSpriteFrameCache {
    static cocos2d::CCSpriteFrameCache* sharedSpriteFrameCache() = imac 0x307280;
    ...
    void addSpriteFramesWithFile(char const*) = imac 0x308180;
    ...
    void removeSpriteFramesFromTexture(cocos2d::CCTexture2D*) = imac 0x308e10;
    void removeUnusedSpriteFrames() = imac 0x308630;
    cocos2d::CCSpriteFrame* spriteFrameByName(char const*) = imac 0x309120;
    //purgeSharedSpriteFrameCache = ios 0x3c4dd4
}

[[link(win, android)]]
class cocos2d::CCString {
    static cocos2d::CCString* createWithData(unsigned char const*, unsigned long) = imac 0x794ad0;
    // static cocos2d::CCString* createWithFormat(char const*, ...) = ios 0x278aec;

    char const* getCString() const;
    //createWithContentsOfFile = ios 0x278b74;

    bool boolValue() const = imac 0x7948c0;
    int intValue() const;
}
...
class cocos2d::CCMenuItem {
    ~CCMenuItem();
    static cocos2d::CCMenuItem* create(cocos2d::CCObject*, cocos2d::SEL_MenuHandler) = imac 0x3aabd0;
    static cocos2d::CCMenuItem* create() = imac 0x3aab10;

    bool initWithTarget(cocos2d::CCObject*, cocos2d::SEL_MenuHandler) = imac 0x3aaca0;
    ...
    virtual void activate() = imac 0x3aaee0;
...
class cocos2d::CCMenuItemSprite {
    bool initWithNormalSprite(cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler) = imac 0x3ac410;

    virtual void selected() = imac 0x3ac500;
    virtual void unselected() = imac 0x3ac5a0;
    virtual void setEnabled(bool) = imac 0x3ac620;
    virtual cocos2d::CCNode* getNormalImage();
    virtual void setNormalImage(cocos2d::CCNode*) = imac 0x3ac060;
    virtual cocos2d::CCNode* getSelectedImage();
    virtual void setSelectedImage(cocos2d::CCNode*) = imac 0x3ac130;
    virtual cocos2d::CCNode* getDisabledImage();
    virtual void setDisabledImage(cocos2d::CCNode*) = imac 0x3ac1d0;
    virtual void updateImagesVisibility() = imac 0x3ac640;
}

[[link(win, android)]]
class cocos2d::CCMenu {
    // static cocos2d::CCMenu* create(cocos2d::CCMenuItem*, ...) = ios 0x1e1964, m1 0x6a6d58, imac 0x79e7b0;
    static cocos2d::CCMenu* create() = imac 0x77bd60;
    static cocos2d::CCMenu* createWithArray(cocos2d::CCArray*) = imac 0x77bf60;
    static cocos2d::CCMenu* createWithItem(cocos2d::CCMenuItem*) = imac 0x77c1b0;
    ...
    virtual bool init() = imac 0x77c1c0;
    virtual void addChild(cocos2d::CCNode*);
    virtual void addChild(cocos2d::CCNode*, int);
    virtual void addChild(cocos2d::CCNode*, int, int) = imac 0x77c1f0;
    virtual void removeChild(cocos2d::CCNode*, bool) = imac 0x77c290;
    virtual void onExit() = imac 0x77c240;
    virtual void registerWithTouchDispatcher();

    virtual bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = imac 0x77c390;
    virtual void ccTouchMoved(cocos2d::CCTouch*, cocos2d::CCEvent*) = imac 0x77c640;
    virtual void ccTouchEnded(cocos2d::CCTouch*, cocos2d::CCEvent*) = imac 0x77c560;
    virtual void ccTouchCancelled(cocos2d::CCTouch*, cocos2d::CCEvent*) = imac 0x77c5e0;
}

[[link(win, android)]]
class cocos2d::CCRotateBy {
    static cocos2d::CCRotateBy* create(float, float) = imac 0x3a3ff0;
...
class cocos2d::CCRotateTo {
    static cocos2d::CCRotateTo* create(float, float) = imac 0x3a3b10;
...
class DS_Dictionary {
    ...
    gd::vector<gd::string> getAllKeys() = imac 0x16c5b0;
    cocos2d::CCArray* getArrayForKey(char const*, bool) = imac 0x1700b0;
    bool getBoolForKey(char const*);
    cocos2d::CCDictionary* getDictForKey(char const*, bool);
    float getFloatForKey(char const*) = imac 0x16cde0;
    unsigned int getIndexOfKey(char const*);
    unsigned int getIndexOfKeyWithClosestAlphaNumericalMatch(char const*);
    int getIntegerForKey(char const*) = imac 0x16cba0;
    gd::string getKey(unsigned int) = imac 0x16c480;
    unsigned int getNumKeys();
    cocos2d::CCObject* getObjectForKey(char const*) = imac 0x170230;
    ...
    bool loadRootSubDictFromCompressedFile(char const*) = imac 0x169eb0;
    ...
    gd::string saveRootSubDictToString() = imac 0x16b930;
    void setArrayForKey(char const*, cocos2d::CCArray*);
    void setBoolForKey(char const*, bool, bool);
    void setBoolForKey(char const*, bool) = imac 0x16e090;
    void setBoolMapForKey(char const*, gd::map<gd::string, bool>&);
    void setDictForKey(char const*, cocos2d::CCDictionary*) = imac 0x1706b0;
    ...
    bool stepIntoSubDictWithKey(char const*) = imac 0x16bed0;
    void stepOutOfSubDict() = imac 0x16c1a0;
...
class cocos2d::extension::CCScale9Sprite {
    ...
    virtual bool init() = imac 0x3e14a0;
    virtual void setContentSize(const cocos2d::CCSize& size);
    virtual void visit() = imac 0x3e3910;
    ...
    virtual bool isOpacityModifyRGB();
    virtual cocos2d::CCSize getPreferredSize() = imac 0x3e3360;
    virtual void setPreferredSize(cocos2d::CCSize) = imac 0x3e3330;
    virtual cocos2d::CCRect getCapInsets() = imac 0x3e3420;
    virtual void setCapInsets(cocos2d::CCRect) = imac 0x3e3380;
    ...
    virtual bool initWithBatchNode(cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, bool, cocos2d::CCRect) = imac 0x3e1560;
    virtual bool initWithBatchNode(cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, cocos2d::CCRect) = imac 0x3e1500;
    virtual bool initWithFile(const char*, cocos2d::CCRect, cocos2d::CCRect) = imac 0x3e2ae0;
    virtual bool initWithFile(const char*, cocos2d::CCRect);
    virtual bool initWithFile(cocos2d::CCRect, const char*) = imac 0x3e2ce0;
    virtual bool initWithFile(const char*);
    virtual bool initWithSpriteFrame(cocos2d::CCSpriteFrame*, cocos2d::CCRect) = imac 0x3e2e90;
    virtual bool initWithSpriteFrame(cocos2d::CCSpriteFrame*);
    ...
    virtual void setSpriteFrame(cocos2d::CCSpriteFrame*) = imac 0x3e37c0;
}

[[link(win, android)]]
class cocos2d::extension::CCHttpClient : cocos2d::CCObject {
    // CCHttpClient() = imac 0x441fb0, m1 0x3b3ec8;
    static cocos2d::extension::CCHttpClient* getInstance() = imac 0x424960;
    static void destroyInstance();
    void send(cocos2d::extension::CCHttpRequest* request) = imac 0x425870;
    bool lazyInitThreadSemphore() = imac 0x424cc0;
...
class cocos2d::ZipUtils {
    ...
    static int ccDeflateMemory(unsigned char*, unsigned int, unsigned char**) = imac 0x1f2b90;
    ...
    static gd::string compressString(gd::string const&, bool, int) = imac 0x1f2920;
...
class cocos2d::CCSpeed {
    static cocos2d::CCSpeed* create(cocos2d::CCActionInterval*, float) = imac 0x5dc0c0;
...
class cocos2d::CCLightning : cocos2d::CCNode, cocos2d::CCRGBAProtocol {
    static cocos2d::CCLightning* lightningWithStrikePoint(cocos2d::CCPoint, cocos2d::CCPoint, float) = imac 0x5c4cc0;
    ...
    virtual void draw() = imac 0x5c4fb0;
    virtual bool isOpacityModifyRGB();
    virtual void setOpacityModifyRGB(bool);
    virtual unsigned char getOpacity();
    virtual unsigned char getDisplayedOpacity();
