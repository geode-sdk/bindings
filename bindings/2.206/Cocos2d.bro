...
class DS_Dictionary {
	...
	gd::string getKey(unsigned int) = imac 0x1789b0;
	unsigned int getNumKeys();
	cocos2d::CCObject* getObjectForKey(char const*) = imac 0x17c5f0;
	...
	void setBoolForKey(char const*, bool) = imac 0x17a570;
	void setBoolMapForKey(char const*, gd::map<gd::string, bool>&);
	void setDictForKey(char const*, cocos2d::CCDictionary*) = imac 0x17ca80;
	void setFloatForKey(char const*, float) = imac 0x17a7a0;
	void setFloatForKey(char const*, float, bool);
	void setIntegerForKey(char const*, int) = imac 0x17a2a0;
	...
	void setStringForKey(char const*, gd::string const&) = imac 0x17aa90;
