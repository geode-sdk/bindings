...
class CCTextInputNode : cocos2d::CCLayer, cocos2d::CCIMEDelegate, cocos2d::CCTextFieldDelegate {
	...
	void updateBlinkLabel() {
		this->updateBlinkLabelToChar(this->m_textField->m_uiCursorPos);
	}
	...
	bool m_forceOffset;
	TextArea* m_textArea;
	PAD = android32 0xc, android64 0x10, win 0x10, m1 0x18, imac 0x18;
}
...
class FMODAudioEngine : cocos2d::CCNode {
	...
	FMOD::Channel* getActiveMusicChannel(int) = win 0x58e50, imac 0x3e5fd0;
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
	...
	PAD = win 0x8, android32 0x4, android64 0x8, imac 0x8, m1 0x8;
