...
class CustomizeObjectLayer : FLAlertLayer, TextInputDelegate, HSVWidgetDelegate, ColorSelectDelegate, ColorSetupDelegate {
	...
	void onSelectMode(cocos2d::CCObject* sender) = win 0xa6ed0, imac 0x1f13b0, ios 0x55b84;
...
class DailyLevelPage : FLAlertLayer, FLAlertLayerProtocol, GJDailyLevelDelegate, LevelDownloadDelegate {
	...
	static DailyLevelPage* create(GJTimedLevelType) = win 0xcb380, ios 0x1c3b7c;
...
class DialogLayer : cocos2d::CCLayerColor, TextAreaDelegate {
	...
	static DialogLayer* create(DialogObject*, int) = imac 0x3cac60, ios 0x8a280;
...
class EditorUI : cocos2d::CCLayer, FLAlertLayerProtocol, ColorSelectDelegate, GJRotationControlDelegate, GJScaleControlDelegate, GJTransformControlDelegate, MusicDownloadDelegate, SetIDPopupDelegate {
	...
	static EditorUI* create(LevelEditorLayer*) = imac 0x9460, ios 0x3cd9ec;
	static EditorUI* get() {
...
class FMODAudioEngine : cocos2d::CCNode {
	...
	void pauseAllMusic() = ios 0x143494;
...
class GameManager : GManager {
	...
	void reportPercentageForLevel(int, int, bool) = win 0x1748a0, ios 0x324494;
...
class GameStatsManager : cocos2d::CCNode {
	...
	void awardCurrencyForLevel(GJGameLevel*) = win 0x1d6500, ios 0x3429d4;
	...
	void checkCoinAchievement(GJGameLevel*) = win 0x1d3430, ios 0x34076c;
	...
	void completedDemonLevel(GJGameLevel*) = ios 0x34106c;
	TodoReturn completedLevel(GJGameLevel*) = ios 0x340f6c;
...
class GameToolbox {
	...
	static TodoReturn intToString(int) = win 0x67a70, ios 0x4e558;
	static bool isIOS();
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
	...
	void shakeCamera(float, float, float) = imac 0x14f790, ios 0x20df2c;
...
class GJGameLevel : cocos2d::CCNode {
	...
	void savePercentage(int percent, bool, int clicks, int attempts, bool) = win 0x164540, m1 0x4b0f44, imac 0x562730, ios 0xae180;
...
class InfoLayer : FLAlertLayer, LevelCommentDelegate, CommentUploadDelegate, FLAlertLayerProtocol {
	...
	static InfoLayer* create(GJGameLevel*, GJUserScore*, GJLevelList*) = win 0x2a82d0, ios 0x35e1e0;
...
class LevelLeaderboard : FLAlertLayer, LeaderboardManagerDelegate, FLAlertLayerProtocol {
	...
	static LevelLeaderboard* create(GJGameLevel*, LevelLeaderboardType, LevelLeaderboardMode) = win 0x2e0520, ios 0x25ed78;
...
class UILayer : cocos2d::CCLayerColor {
	...
	static UILayer* create(GJBaseGameLayer*) = m1 0x42fd64, ios 0x4f538;
